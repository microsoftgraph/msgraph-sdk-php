    ...
    */
    public function getManager()
    {
        if (array_key_exists("manager", $this->_propDict)) {
            if (is_a($this->_propDict["manager"], "\Microsoft\Graph\Model\SynchronizationJobSubject") || is_null($this->_propDict["manager"])) {
    ...
    */
    public function getMembers()
    {
        if (array_key_exists("members", $this->_propDict)) {
            if (is_a($this->_propDict["members"], "\Microsoft\Graph\Model\SynchronizationJobSubject") || is_null($this->_propDict["members"])) {
    ...
    */
    public function getOwners()
    {
        if (array_key_exists("owners", $this->_propDict)) {
            if (is_a($this->_propDict["owners"], "\Microsoft\Graph\Model\SynchronizationJobSubject") || is_null($this->_propDict["owners"])) {

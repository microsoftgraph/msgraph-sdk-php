...
class RegistrationEnforcement extends Entity
{
    ...
    */
    ...
    {
        if (array_key_exists("authenticationMethodsRegistrationCampaign", $this->_propDict) && !is_null($this->_propDict["authenticationMethodsRegistrationCampaign"])) {
     
            if (is_a($this->_propDict["authenticationMethodsRegistrationCampaign"], "\Microsoft\Graph\Model\AuthenticationMethodsRegistrationCampaign")) {

...
class AccessPackageCatalog extends Entity
{
    ...
    */
    ...
    {
        if (array_key_exists("catalogType", $this->_propDict) && !is_null($this->_propDict["catalogType"])) {
            if (is_a($this->_propDict["catalogType"], "\Microsoft\Graph\Model\AccessPackageCatalogType")) {
    ...
    */
    public function getState()
    {
        if (array_key_exists("state", $this->_propDict) && !is_null($this->_propDict["state"])) {
            if (is_a($this->_propDict["state"], "\Microsoft\Graph\Model\AccessPackageCatalogState")) {

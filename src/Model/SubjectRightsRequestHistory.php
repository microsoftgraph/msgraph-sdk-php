    ...
    */
    public function getChangedBy()
    {
        if (array_key_exists("changedBy", $this->_propDict) && !is_null($this->_propDict["changedBy"])) {
            ...
            if (is_a($this->_propDict["changedBy"], "\Microsoft\Graph\Model\IdentitySet")) {
    ...
    */
    public function getStageStatus()
    {
        if (array_key_exists("stageStatus", $this->_propDict) && !is_null($this->_propDict["stageStatus"])) {
            ...
            if (is_a($this->_propDict["stageStatus"], "\Microsoft\Graph\Model\SubjectRightsRequestStageStatus")) {

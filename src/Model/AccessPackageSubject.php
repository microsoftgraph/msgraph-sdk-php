...
class AccessPackageSubject extends Entity
{
    ...
    */
    ...
    {
        if (array_key_exists("subjectType", $this->_propDict) && !is_null($this->_propDict["subjectType"])) {
            if (is_a($this->_propDict["subjectType"], "\Microsoft\Graph\Model\AccessPackageSubjectType")) {
    ...
    */
    public function getConnectedOrganization()
    {
        if (array_key_exists("connectedOrganization", $this->_propDict) && !is_null($this->_propDict["connectedOrganization"])) {
            if (is_a($this->_propDict["connectedOrganization"], "\Microsoft\Graph\Model\ConnectedOrganization")) {

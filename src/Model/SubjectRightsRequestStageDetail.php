    ...
    */
    public function getStage()
    {
        if (array_key_exists("stage", $this->_propDict) && !is_null($this->_propDict["stage"])) {
            ...
            if (is_a($this->_propDict["stage"], "\Microsoft\Graph\Model\SubjectRightsRequestStage")) {
    ...
    */
    public function getStatus()
    {
        if (array_key_exists("status", $this->_propDict) && !is_null($this->_propDict["status"])) {
            ...
            if (is_a($this->_propDict["status"], "\Microsoft\Graph\Model\SubjectRightsRequestStageStatus")) {

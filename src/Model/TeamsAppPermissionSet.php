    ...
    */
    public function getResourceSpecificPermissions()
    {
        if (array_key_exists("resourceSpecificPermissions", $this->_propDict)) {
            if (is_a($this->_propDict["resourceSpecificPermissions"], "\Microsoft\Graph\Model\TeamsAppResourceSpecificPermission") || is_null($this->_propDict["resourceSpecificPermissions"])) {

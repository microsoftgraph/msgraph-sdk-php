...
class MeetingAttendanceReport extends Entity
{
    ...
    */
    ...
    {
        if (array_key_exists("meetingEndDateTime", $this->_propDict) && !is_null($this->_propDict["meetingEndDateTime"])) {
            if (is_a($this->_propDict["meetingEndDateTime"], "\DateTime")) {
    ...
    */
    ...
    {
        if (array_key_exists("meetingStartDateTime", $this->_propDict) && !is_null($this->_propDict["meetingStartDateTime"])) {
            if (is_a($this->_propDict["meetingStartDateTime"], "\DateTime")) {

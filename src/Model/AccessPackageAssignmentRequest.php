...
class AccessPackageAssignmentRequest extends Entity
{
    ...
    */
    ...
    {
        if (array_key_exists("requestType", $this->_propDict) && !is_null($this->_propDict["requestType"])) {
            if (is_a($this->_propDict["requestType"], "\Microsoft\Graph\Model\AccessPackageRequestType")) {
    ...
    */
    public function getState()
    {
        if (array_key_exists("state", $this->_propDict) && !is_null($this->_propDict["state"])) {
            if (is_a($this->_propDict["state"], "\Microsoft\Graph\Model\AccessPackageRequestState")) {
    ...
    */
    ...
    {
        if (array_key_exists("assignment", $this->_propDict) && !is_null($this->_propDict["assignment"])) {
            if (is_a($this->_propDict["assignment"], "\Microsoft\Graph\Model\AccessPackageAssignment")) {
    ...
    */
    public function getRequestor()
    {
        if (array_key_exists("requestor", $this->_propDict) && !is_null($this->_propDict["requestor"])) {
            if (is_a($this->_propDict["requestor"], "\Microsoft\Graph\Model\AccessPackageSubject")) {

    ...
    */
    public function getAutopilotDevicesSummary()
    {
        if (array_key_exists("autopilotDevicesSummary", $this->_propDict)) {
            if (is_a($this->_propDict["autopilotDevicesSummary"], "\Microsoft\Graph\Model\UserExperienceAnalyticsAutopilotDevicesSummary") || is_null($this->_propDict["autopilotDevicesSummary"])) {
    ...
    */
    public function getCloudIdentityDevicesSummary()
    {
        if (array_key_exists("cloudIdentityDevicesSummary", $this->_propDict)) {
            if (is_a($this->_propDict["cloudIdentityDevicesSummary"], "\Microsoft\Graph\Model\UserExperienceAnalyticsCloudIdentityDevicesSummary") || is_null($this->_propDict["cloudIdentityDevicesSummary"])) {
    ...
    */
    public function getCloudManagementDevicesSummary()
    {
        if (array_key_exists("cloudManagementDevicesSummary", $this->_propDict)) {
            if (is_a($this->_propDict["cloudManagementDevicesSummary"], "\Microsoft\Graph\Model\UserExperienceAnalyticsCloudManagementDevicesSummary") || is_null($this->_propDict["cloudManagementDevicesSummary"])) {
    ...
    */
    public function getWindows10DevicesSummary()
    {
        if (array_key_exists("windows10DevicesSummary", $this->_propDict)) {
            if (is_a($this->_propDict["windows10DevicesSummary"], "\Microsoft\Graph\Model\UserExperienceAnalyticsWindows10DevicesSummary") || is_null($this->_propDict["windows10DevicesSummary"])) {

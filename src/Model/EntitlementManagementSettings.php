...
class EntitlementManagementSettings extends Entity
{
    ...
    */
    ...
    {
        if (array_key_exists("durationUntilExternalUserDeletedAfterBlocked", $this->_propDict) && !is_null($this->_propDict["durationUntilExternalUserDeletedAfterBlocked"])) {
            if (is_a($this->_propDict["durationUntilExternalUserDeletedAfterBlocked"], "\DateInterval")) {
    ...
    */
    ...
    {
        if (array_key_exists("externalUserLifecycleAction", $this->_propDict) && !is_null($this->_propDict["externalUserLifecycleAction"])) {
            if (is_a($this->_propDict["externalUserLifecycleAction"], "\Microsoft\Graph\Model\AccessPackageExternalUserLifecycleAction")) {

...
class QueryPostResponse extends BaseCollectionPaginationCountResponse implements Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): QueryPostResponse {
    ...
    */
    public function getValue(): ?array {
        ...
        if (is_array($val) || is_null($val)) {
            TypeUtils::validateCollectionValues($val, SearchResponse::class);
            /** @var array<SearchResponse>|null $val */
            return $val;
        }

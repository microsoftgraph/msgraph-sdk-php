...
namespace Microsoft\Graph\Generated\Security\Identities\HealthIssues\Item;
...
*/
class HealthIssueItemRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/security/identities/healthIssues/{healthIssue%2Did}');
     ...
     * @param HealthIssueItemRequestBuilderDeleteRequestConfiguration|null $requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @return Promise<void|null>
     * @throws Exception
    */
    public function delete(?HealthIssueItemRequestBuilderDeleteRequestConfiguration $requestConfiguration = null): Promise {
    ...
    */
    public function toDeleteRequestInformation(?HealthIssueItemRequestBuilderDeleteRequestConfiguration $requestConfiguration = null): RequestInformation {
     ...
     * @return RequestInformation
    */
    public function toGetRequestInformation(?HealthIssueItemRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/security/identities/healthIssues/{healthIssue%2Did}{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
     ...
     * @return RequestInformation
    */
    public function toPatchRequestInformation(HealthIssue $body, ?HealthIssueItemRequestBuilderPatchRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = $this->urlTemplate;
        $requestInfo->pathParameters = $this->pathParameters;
    ...
    */
    public function withUrl(string $rawUrl): HealthIssueItemRequestBuilder {
        return new HealthIssueItemRequestBuilder($rawUrl, $this->requestAdapter);
    }

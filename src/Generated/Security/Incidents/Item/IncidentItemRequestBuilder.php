...
class IncidentItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $incidentId key: id of incident
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $incidentId = null) {
        $this->urlTemplate = '{+baseurl}/security/incidents/{incident%2Did}{?%24select,%24expand}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['incidentId'] = $incidentId;

...
*/
class MicrosoftGraphSecurityMergeIncidentsRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/security/incidents/microsoft.graph.security.mergeIncidents');
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/security-incident-mergeincidents?view=graph-rest-1.0 Find more info here
    */
    ...
    */
     ...
     * @return MicrosoftGraphSecurityMergeIncidentsRequestBuilder
    */
    public function withUrl(string $rawUrl): MicrosoftGraphSecurityMergeIncidentsRequestBuilder {
        return new MicrosoftGraphSecurityMergeIncidentsRequestBuilder($rawUrl, $this->requestAdapter);
    }

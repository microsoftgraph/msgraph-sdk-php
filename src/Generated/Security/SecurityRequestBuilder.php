...
use Microsoft\Graph\Generated\Security\Alerts_v2\Item\AlertItemRequestBuilder as MicrosoftGraphGeneratedSecurityAlerts_v2ItemAlertItemRequestBuilder;
use Microsoft\Graph\Generated\Security\Alerts\AlertsRequestBuilder;
use Microsoft\Graph\Generated\Security\Alerts\Item\AlertItemRequestBuilder as MicrosoftGraphGeneratedSecurityAlertsItemAlertItemRequestBuilder;
...
class SecurityRequestBuilder 
{
    ...
    */
     ...
     * @return MicrosoftGraphGeneratedSecurityAlerts_v2ItemAlertItemRequestBuilder
    */
    public function alerts_v2ById(string $id): MicrosoftGraphGeneratedSecurityAlerts_v2ItemAlertItemRequestBuilder {
        $urlTplParams = $this->pathParameters;
        $urlTplParams['alert%2Did'] = $id;
        return new MicrosoftGraphGeneratedSecurityAlerts_v2ItemAlertItemRequestBuilder($urlTplParams, $this->requestAdapter);
    }

    /**
     * Provides operations to manage the alerts property of the microsoft.graph.security entity.
     * @param string $id Unique identifier of the item
     * @return MicrosoftGraphGeneratedSecurityAlertsItemAlertItemRequestBuilder
    */
    public function alertsById(string $id): MicrosoftGraphGeneratedSecurityAlertsItemAlertItemRequestBuilder {
        $urlTplParams = $this->pathParameters;
        $urlTplParams['alert%2Did'] = $id;
        return new MicrosoftGraphGeneratedSecurityAlertsItemAlertItemRequestBuilder($urlTplParams, $this->requestAdapter);
    }

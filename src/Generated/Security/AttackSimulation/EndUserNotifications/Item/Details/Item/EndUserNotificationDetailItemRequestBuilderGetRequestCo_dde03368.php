...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: EndUserNotificationDetailItemRequestBuilderGetRequestConfiguration
*/
class EndUserNotificationDetailItemRequestBuilderGetRequestCo_dde03368 extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new EndUserNotificationDetailItemRequestBuilderGetRequestCo_dde03368 and sets the default values.

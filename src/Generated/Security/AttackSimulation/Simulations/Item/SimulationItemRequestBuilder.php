...
class SimulationItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $simulationId key: id of simulation
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $simulationId = null) {
        $this->urlTemplate = '{+baseurl}/security/attackSimulation/simulations/{simulation%2Did}{?%24select,%24expand}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['simulationId'] = $simulationId;

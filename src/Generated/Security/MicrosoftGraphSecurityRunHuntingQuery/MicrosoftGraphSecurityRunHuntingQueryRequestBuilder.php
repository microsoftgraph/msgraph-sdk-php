...
class MicrosoftGraphSecurityRunHuntingQueryRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
     ...
     * @param MicrosoftGraphSecurityRunHuntingQueryRequestBuilderPost_20dd320f|null $requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @return Promise<HuntingQueryResults|null>
     * @throws Exception
    */
    public function post(RunHuntingQueryPostRequestBody $body, ?MicrosoftGraphSecurityRunHuntingQueryRequestBuilderPost_20dd320f $requestConfiguration = null): Promise {
    ...
    */
    public function toPostRequestInformation(RunHuntingQueryPostRequestBody $body, ?MicrosoftGraphSecurityRunHuntingQueryRequestBuilderPost_20dd320f $requestConfiguration = null): RequestInformation {

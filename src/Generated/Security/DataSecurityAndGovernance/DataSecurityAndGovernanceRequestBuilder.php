...
class DataSecurityAndGovernanceRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function processContentAsync(): ProcessContentAsyncRequestBuilder {
        return new ProcessContentAsyncRequestBuilder($this->pathParameters, $this->requestAdapter);
    }
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/security/dataSecurityAndGovernance');
    ...
    */
     ...
     * @return Promise<TenantDataSecurityAndGovernance|null>
     * @throws Exception
    */
    public function get(?DataSecurityAndGovernanceRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
        ...
        return $this->requestAdapter->sendAsync($requestInfo, [TenantDataSecurityAndGovernance::class, 'createFromDiscriminatorValue'], $errorMappings);
    }

    /**
     * Update the navigation property dataSecurityAndGovernance in security
     * @param TenantDataSecurityAndGovernance $body The request body
     ...
     * @throws Exception
    */
    public function patch(TenantDataSecurityAndGovernance $body, ?DataSecurityAndGovernanceRequestBuilderPatchRequestConfiguration $requestConfiguration = null): Promise {
    ...
    */
    public function toGetRequestInformation(?DataSecurityAndGovernanceRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/security/dataSecurityAndGovernance{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
     ...
     * @return RequestInformation
    */
    public function toPatchRequestInformation(TenantDataSecurityAndGovernance $body, ?DataSecurityAndGovernanceRequestBuilderPatchRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = $this->urlTemplate;
        $requestInfo->pathParameters = $this->pathParameters;

...
*/
class AuditLogRecordItemRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/security/auditLog/queries/{auditLogQuery%2Did}/records/{auditLogRecord%2Did}{?%24expand,%24select}');
     ...
     * @throws Exception
    */
    public function get(?AuditLogRecordItemRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
    ...
    */
    public function toGetRequestInformation(?AuditLogRecordItemRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
    ...
    */
    public function withUrl(string $rawUrl): AuditLogRecordItemRequestBuilder {
        return new AuditLogRecordItemRequestBuilder($rawUrl, $this->requestAdapter);
    }

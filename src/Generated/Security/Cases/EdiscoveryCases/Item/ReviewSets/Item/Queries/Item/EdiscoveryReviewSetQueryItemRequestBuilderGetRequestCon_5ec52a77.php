...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: EdiscoveryReviewSetQueryItemRequestBuilderGetRequestConfiguration
*/
class EdiscoveryReviewSetQueryItemRequestBuilderGetRequestCon_5ec52a77 extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new EdiscoveryReviewSetQueryItemRequestBuilderGetRequestCon_5ec52a77 and sets the default values.
    ...
    */
    public static function createQueryParameters(?array $expand = null, ?array $select = null): EdiscoveryReviewSetQueryItemRequestBuilderGetQueryParameters {

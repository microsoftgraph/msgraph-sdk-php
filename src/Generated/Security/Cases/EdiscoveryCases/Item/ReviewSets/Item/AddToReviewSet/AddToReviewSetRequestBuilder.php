...
class AddToReviewSetRequestBuilder 
{
    ...
    */
    public function toPostRequestInformation(AddToReviewSetPostRequestBody $body, ?AddToReviewSetRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {

...
class FilterGroup implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function getClauses(): ?array {
        $val = $this->getBackingStore()->get('clauses');
        if (is_array($val) || is_null($val)) {
            TypeUtils::validateCollectionValues($val, FilterClause::class);
            /** @var array<FilterClause>|null $val */
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'clauses'");
    }
    ...
    */
    public function setClauses(?array $value): void {
        $this->getBackingStore()->set('clauses', $value);
    }

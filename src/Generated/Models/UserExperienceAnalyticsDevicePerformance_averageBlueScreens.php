...
*/
class UserExperienceAnalyticsDevicePerformance_averageBlueScreens implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new UserExperienceAnalyticsDevicePerformance_averageBlueScreens and sets the default values.
    */
     ...
     * @return UserExperienceAnalyticsDevicePerformance_averageBlueScreens
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): UserExperienceAnalyticsDevicePerformance_averageBlueScreens {
        $result = new UserExperienceAnalyticsDevicePerformance_averageBlueScreens();

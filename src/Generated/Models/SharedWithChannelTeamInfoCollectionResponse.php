...
class SharedWithChannelTeamInfoCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var array<SharedWithChannelTeamInfo>|null $value The value property
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): SharedWithChannelTeamInfoCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($o) { $o->setValue($n->getCollectionOfObjectValues(array(SharedWithChannelTeamInfo::class, 'createFromDiscriminatorValue'))); },
        ];
    }

...
class RichLongRunningOperationCollectionResponse implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var array<RichLongRunningOperation>|null $value The value property
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): RichLongRunningOperationCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($o) { $o->setValue($n->getCollectionOfObjectValues(array(RichLongRunningOperation::class, 'createFromDiscriminatorValue'))); },
        ];
    }

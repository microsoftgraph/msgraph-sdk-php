...
*/
class DeviceGeoLocation_verticalAccuracy implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new DeviceGeoLocation_verticalAccuracy and sets the default values.
    */
     ...
     * @return DeviceGeoLocation_verticalAccuracy
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): DeviceGeoLocation_verticalAccuracy {
        $result = new DeviceGeoLocation_verticalAccuracy();

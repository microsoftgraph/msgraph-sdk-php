...
class GroupFilter implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
     ...
     * @return GroupFilter
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): GroupFilter {

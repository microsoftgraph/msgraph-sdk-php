...
*/
class UserExperienceAnalyticsAppHealthAppPerformanceByAppVers_d22979be extends Entity implements Parsable 
{
    /**
     * Instantiates a new UserExperienceAnalyticsAppHealthAppPerformanceByAppVers_d22979be and sets the default values.
    */
     ...
     * @return UserExperienceAnalyticsAppHealthAppPerformanceByAppVers_d22979be
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): UserExperienceAnalyticsAppHealthAppPerformanceByAppVers_d22979be {
        return new UserExperienceAnalyticsAppHealthAppPerformanceByAppVers_d22979be();
    }

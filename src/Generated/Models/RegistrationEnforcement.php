...
class RegistrationEnforcement implements AdditionalDataHolder, BackedModel, Parsable 
{
    ...
    */
    public function getAuthenticationMethodsRegistrationCampaign(): ?AuthenticationMethodsRegistrationCampaign {
        $val = $this->getBackingStore()->get('authenticationMethodsRegistrationCampaign');
        if (is_null($val) || $val instanceof AuthenticationMethodsRegistrationCampaign) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'authenticationMethodsRegistrationCampaign'");
    }

...
*/
class UserExperienceAnalyticsDeviceScores_batteryHealthScore implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new UserExperienceAnalyticsDeviceScores_batteryHealthScore and sets the default values.
    */
     ...
     * @return UserExperienceAnalyticsDeviceScores_batteryHealthScore
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): UserExperienceAnalyticsDeviceScores_batteryHealthScore {
        $result = new UserExperienceAnalyticsDeviceScores_batteryHealthScore();

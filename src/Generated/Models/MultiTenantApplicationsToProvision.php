...
class MultiTenantApplicationsToProvision implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new MultiTenantApplicationsToProvision and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): MultiTenantApplicationsToProvision {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'requiredResourceAccesses' => fn(ParseNode $n) => $o->setRequiredResourceAccesses($n->getCollectionOfObjectValues([ApplicationsRequiredResourceAccess::class, 'createFromDiscriminatorValue'])),
        ];
    }
    ...
    */
    public function getRequiredResourceAccesses(): ?array {
        ...
        if (is_array($val) || is_null($val)) {
            TypeUtils::validateCollectionValues($val, ApplicationsRequiredResourceAccess::class);
            /** @var array<ApplicationsRequiredResourceAccess>|null $val */
            return $val;
        }

...
class AuthorizationInfo implements AdditionalDataHolder, BackedModel, Parsable 
{
    ...
    */
    public function getCertificateUserIds(): ?array {
        $val = $this->getBackingStore()->get('certificateUserIds');
        if (is_array($val) || is_null($val)) {
            TypeUtils::validateCollectionValues($val, 'string');
            /** @var array<string>|null $val */
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'certificateUserIds'");
    }
    ...
    */
    public function getFieldDeserializers(): array {
        $o = $this;
        return  [
            'certificateUserIds' => function (ParseNode $n) {
                $val = $n->getCollectionOfPrimitiveValues();
                if (is_array($val)) {
                    TypeUtils::validateCollectionValues($val, 'string');
                }
                /** @var array<string>|null $val */
                $this->setCertificateUserIds($val);
            },

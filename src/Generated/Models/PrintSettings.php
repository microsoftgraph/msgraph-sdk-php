...
class PrintSettings implements AdditionalDataHolder, BackedModel, Parsable 
{
    ...
    */
    public function getDocumentConversionEnabled(): ?bool {
        $val = $this->getBackingStore()->get('documentConversionEnabled');
        if (is_null($val) || is_bool($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'documentConversionEnabled'");
    }

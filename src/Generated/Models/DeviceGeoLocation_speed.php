...
*/
class DeviceGeoLocation_speed implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new DeviceGeoLocation_speed and sets the default values.
    */
     ...
     * @return DeviceGeoLocation_speed
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): DeviceGeoLocation_speed {
        $result = new DeviceGeoLocation_speed();

...
class DetonationObservables implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function getContactedIps(): ?array {
        $val = $this->getBackingStore()->get('contactedIps');
        if (is_array($val) || is_null($val)) {
            TypeUtils::validateCollectionValues($val, 'string');
            /** @var array<string>|null $val */
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'contactedIps'");
    }
    ...
    */
    public function getContactedUrls(): ?array {
        $val = $this->getBackingStore()->get('contactedUrls');
        if (is_array($val) || is_null($val)) {
            TypeUtils::validateCollectionValues($val, 'string');
            /** @var array<string>|null $val */
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'contactedUrls'");
    }
    ...
    */
    public function getDroppedfiles(): ?array {
        $val = $this->getBackingStore()->get('droppedfiles');
        if (is_array($val) || is_null($val)) {
            TypeUtils::validateCollectionValues($val, 'string');
            /** @var array<string>|null $val */
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'droppedfiles'");
    }
    ...
    */
    public function setContactedIps(?array $value): void {
        $this->getBackingStore()->set('contactedIps', $value);
    }
    ...
    */
    public function setContactedUrls(?array $value): void {
        $this->getBackingStore()->set('contactedUrls', $value);
    }
    ...
    */
    public function setDroppedfiles(?array $value): void {
        $this->getBackingStore()->set('droppedfiles', $value);
    }

...
class ComplianceDlpSharePointClassificationAuditRecord extends AuditData implements Parsable 
{
    /**
     * Instantiates a new ComplianceDlpSharePointClassificationAuditRecord and sets the default values.
    */

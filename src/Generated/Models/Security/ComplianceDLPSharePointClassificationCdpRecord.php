...
*/
class ComplianceDLPSharePointClassificationCdpRecord extends AuditData implements Parsable 
{
    /**
     * Instantiates a new ComplianceDLPSharePointClassificationCdpRecord and sets the default values.
    */

...
*/
class CopilotForSecurityLoggingAuditRecord extends AuditData implements Parsable 
{
    /**
     * Instantiates a new CopilotForSecurityLoggingAuditRecord and sets the default values.
    */

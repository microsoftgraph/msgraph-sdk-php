...
*/
class CvssSummary_score implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new CvssSummary_score and sets the default values.
    */
     ...
     * @return CvssSummary_score
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): CvssSummary_score {
        $result = new CvssSummary_score();

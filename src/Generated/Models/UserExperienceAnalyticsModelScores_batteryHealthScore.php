...
*/
class UserExperienceAnalyticsModelScores_batteryHealthScore implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new UserExperienceAnalyticsModelScores_batteryHealthScore and sets the default values.
    */
     ...
     * @return UserExperienceAnalyticsModelScores_batteryHealthScore
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): UserExperienceAnalyticsModelScores_batteryHealthScore {
        $result = new UserExperienceAnalyticsModelScores_batteryHealthScore();

...
*/
class ControlScore_score implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new ControlScore_score and sets the default values.
    */
     ...
     * @return ControlScore_score
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): ControlScore_score {
        $result = new ControlScore_score();

...
*/
class WorkbookRangeFormat_columnWidth implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new WorkbookRangeFormat_columnWidth and sets the default values.
    */
     ...
     * @return WorkbookRangeFormat_columnWidth
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): WorkbookRangeFormat_columnWidth {
        $result = new WorkbookRangeFormat_columnWidth();

...
class SecureScoreControlProfileCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): SecureScoreControlProfileCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($o) { $o->setValue($n->getCollectionOfObjectValues(array(SecureScoreControlProfile::class, 'createFromDiscriminatorValue'))); },
        ];
    }

...
*/
class UserExperienceAnalyticsAppHealthAppPerformanceByAppVers_666db35f extends Entity implements Parsable 
{
    /**
     * Instantiates a new UserExperienceAnalyticsAppHealthAppPerformanceByAppVers_666db35f and sets the default values.
    */
     ...
     * @return UserExperienceAnalyticsAppHealthAppPerformanceByAppVers_666db35f
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): UserExperienceAnalyticsAppHealthAppPerformanceByAppVers_666db35f {
        return new UserExperienceAnalyticsAppHealthAppPerformanceByAppVers_666db35f();
    }

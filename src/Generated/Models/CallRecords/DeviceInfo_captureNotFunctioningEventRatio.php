...
*/
class DeviceInfo_captureNotFunctioningEventRatio implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new DeviceInfo_captureNotFunctioningEventRatio and sets the default values.
    */
     ...
     * @return DeviceInfo_captureNotFunctioningEventRatio
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): DeviceInfo_captureNotFunctioningEventRatio {
        $result = new DeviceInfo_captureNotFunctioningEventRatio();

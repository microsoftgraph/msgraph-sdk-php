...
*/
class MediaStream_averageVideoFrameLossPercentage implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new MediaStream_averageVideoFrameLossPercentage and sets the default values.
    */
     ...
     * @return MediaStream_averageVideoFrameLossPercentage
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): MediaStream_averageVideoFrameLossPercentage {
        $result = new MediaStream_averageVideoFrameLossPercentage();

...
*/
class DeviceInfo_lowSpeechLevelEventRatio implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new DeviceInfo_lowSpeechLevelEventRatio and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): DeviceInfo_lowSpeechLevelEventRatio {
        $result = new DeviceInfo_lowSpeechLevelEventRatio();

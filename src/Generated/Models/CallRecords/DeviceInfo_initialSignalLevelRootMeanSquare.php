...
*/
class DeviceInfo_initialSignalLevelRootMeanSquare implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new DeviceInfo_initialSignalLevelRootMeanSquare and sets the default values.
    */
     ...
     * @return DeviceInfo_initialSignalLevelRootMeanSquare
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): DeviceInfo_initialSignalLevelRootMeanSquare {
        $result = new DeviceInfo_initialSignalLevelRootMeanSquare();

...
*/
class NetworkInfo_receivedQualityEventRatio implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new NetworkInfo_receivedQualityEventRatio and sets the default values.
    */
     ...
     * @return NetworkInfo_receivedQualityEventRatio
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): NetworkInfo_receivedQualityEventRatio {
        $result = new NetworkInfo_receivedQualityEventRatio();

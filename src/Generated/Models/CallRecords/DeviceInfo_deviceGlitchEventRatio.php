...
*/
class DeviceInfo_deviceGlitchEventRatio implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new DeviceInfo_deviceGlitchEventRatio and sets the default values.
    */
     ...
     * @return DeviceInfo_deviceGlitchEventRatio
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): DeviceInfo_deviceGlitchEventRatio {
        $result = new DeviceInfo_deviceGlitchEventRatio();

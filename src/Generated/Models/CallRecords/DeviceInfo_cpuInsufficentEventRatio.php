...
*/
class DeviceInfo_cpuInsufficentEventRatio implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new DeviceInfo_cpuInsufficentEventRatio and sets the default values.
    */
     ...
     * @return DeviceInfo_cpuInsufficentEventRatio
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): DeviceInfo_cpuInsufficentEventRatio {
        $result = new DeviceInfo_cpuInsufficentEventRatio();

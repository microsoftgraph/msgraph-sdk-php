...
*/
class MediaStream_averagePacketLossRate implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new MediaStream_averagePacketLossRate and sets the default values.
    */
     ...
     * @return MediaStream_averagePacketLossRate
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): MediaStream_averagePacketLossRate {
        $result = new MediaStream_averagePacketLossRate();

...
*/
class NetworkInfo_bandwidthLowEventRatio implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new NetworkInfo_bandwidthLowEventRatio and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): NetworkInfo_bandwidthLowEventRatio {
        $result = new NetworkInfo_bandwidthLowEventRatio();

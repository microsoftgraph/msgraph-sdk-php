...
class DelegatedAdminAccessDetails implements AdditionalDataHolder, BackedModel, Parsable 
{
    ...
    */
    public function getUnifiedRoles(): ?array {
        $val = $this->getBackingStore()->get('unifiedRoles');
        if (is_array($val) || is_null($val)) {
            TypeUtils::validateCollectionValues($val, UnifiedRole::class);
            /** @var array<UnifiedRole>|null $val */
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'unifiedRoles'");
    }

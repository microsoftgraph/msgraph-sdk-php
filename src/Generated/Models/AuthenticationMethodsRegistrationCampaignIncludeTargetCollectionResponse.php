...
{
    /**
     * @var array<AuthenticationMethodsRegistrationCampaignIncludeTarget>|null $value The value property
    */
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            'value' => function (ParseNode $n) use ($o) { $o->setValue($n->getCollectionOfObjectValues(array(AuthenticationMethodsRegistrationCampaignIncludeTarget::class, 'createFromDiscriminatorValue'))); },
        ]);
    }

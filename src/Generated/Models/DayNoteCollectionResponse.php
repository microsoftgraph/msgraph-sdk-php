...
class DayNoteCollectionResponse extends BaseCollectionPaginationCountResponse implements Parsable 
{
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): DayNoteCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            'value' => fn(ParseNode $n) => $o->setValue($n->getCollectionOfObjectValues([DayNote::class, 'createFromDiscriminatorValue'])),
        ]);
    }
    ...
    */
     ...
     * @param array<DayNote>|null $value Value to set for the value property.
    */

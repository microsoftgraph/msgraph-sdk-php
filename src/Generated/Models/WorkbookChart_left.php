...
*/
class WorkbookChart_left implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new WorkbookChart_left and sets the default values.
    */
     ...
     * @return WorkbookChart_left
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): WorkbookChart_left {
        $result = new WorkbookChart_left();

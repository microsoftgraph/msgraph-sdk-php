...
class VirtualEventRegistrationCollectionResponse extends BaseCollectionPaginationCountResponse implements Parsable 
{
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): VirtualEventRegistrationCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            'value' => fn(ParseNode $n) => $o->setValue($n->getCollectionOfObjectValues([VirtualEventRegistration::class, 'createFromDiscriminatorValue'])),
        ]);
    }
    ...
    */
     ...
     * @param array<VirtualEventRegistration>|null $value Value to set for the value property.
    */

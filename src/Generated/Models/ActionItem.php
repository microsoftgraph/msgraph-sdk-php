...
class ActionItem implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
     ...
     * @return ActionItem
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): ActionItem {
    ...
    */
    public function getOwnerDisplayName(): ?string {
        $val = $this->getBackingStore()->get('ownerDisplayName');
        if (is_null($val) || is_string($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'ownerDisplayName'");
    }
    ...
    */
    public function setOwnerDisplayName(?string $value): void {
        $this->getBackingStore()->set('ownerDisplayName', $value);
    }

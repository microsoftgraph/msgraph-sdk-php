...
class OAuthConsentAppDetail implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function getDisplayLogo(): ?string {
        $val = $this->getBackingStore()->get('displayLogo');
        if (is_null($val) || is_string($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'displayLogo'");
    }

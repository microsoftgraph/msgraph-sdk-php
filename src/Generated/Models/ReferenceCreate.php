...
class ReferenceCreate implements AdditionalDataHolder, BackedModel, Parsable 
{
    ...
    */
    public function getOdataId(): ?string {
        $val = $this->getBackingStore()->get('odataId');
        if (is_null($val) || is_string($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'odataId'");
    }
    ...
    */
     ...
     * @param string|null $value Value to set for the @odata.id property.
    */

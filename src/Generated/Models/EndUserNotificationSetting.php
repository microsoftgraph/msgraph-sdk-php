...
class EndUserNotificationSetting implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function getPositiveReinforcement(): ?PositiveReinforcementNotification {
        $val = $this->getBackingStore()->get('positiveReinforcement');
        if (is_null($val) || $val instanceof PositiveReinforcementNotification) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'positiveReinforcement'");
    }
    ...
    */
    public function setPositiveReinforcement(?PositiveReinforcementNotification $value): void {
        $this->getBackingStore()->set('positiveReinforcement', $value);
    }

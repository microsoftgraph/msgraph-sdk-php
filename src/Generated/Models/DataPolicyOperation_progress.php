...
*/
class DataPolicyOperation_progress implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new DataPolicyOperation_progress and sets the default values.
    */

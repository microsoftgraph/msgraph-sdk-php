...
*/
class WebPartPosition_horizontalSectionId implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new WebPartPosition_horizontalSectionId and sets the default values.
    */
     ...
     * @return WebPartPosition_horizontalSectionId
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): WebPartPosition_horizontalSectionId {
        $result = new WebPartPosition_horizontalSectionId();

...
*/
class UserExperienceAnalyticsModelScores_startupPerformanceScore implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new UserExperienceAnalyticsModelScores_startupPerformanceScore and sets the default values.
    */
     ...
     * @return UserExperienceAnalyticsModelScores_startupPerformanceScore
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): UserExperienceAnalyticsModelScores_startupPerformanceScore {
        $result = new UserExperienceAnalyticsModelScores_startupPerformanceScore();

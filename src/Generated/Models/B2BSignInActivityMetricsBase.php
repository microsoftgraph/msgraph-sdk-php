...
class B2BSignInActivityMetricsBase extends Entity implements Parsable 
{
    /**
     * Instantiates a new B2BSignInActivityMetricsBase and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): B2BSignInActivityMetricsBase {
    ...
    */
    public function getInboundMonthlyTotalUsers(): ?string {
        $val = $this->getBackingStore()->get('inboundMonthlyTotalUsers');
        if (is_null($val) || is_string($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'inboundMonthlyTotalUsers'");
    }
    ...
    */
    public function getOutboundMonthlyTotalUsers(): ?string {
        $val = $this->getBackingStore()->get('outboundMonthlyTotalUsers');
        if (is_null($val) || is_string($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'outboundMonthlyTotalUsers'");
    }
    ...
    */
    public function serialize(SerializationWriter $writer): void {
        ...
        $writer->writeStringValue('inboundMonthlyTotalUsers', $this->getInboundMonthlyTotalUsers());
        $writer->writeStringValue('outboundMonthlyTotalApplications', $this->getOutboundMonthlyTotalApplications());
        $writer->writeStringValue('outboundMonthlyTotalUsers', $this->getOutboundMonthlyTotalUsers());
    ...
    */
    public function setInboundMonthlyTotalUsers(?string $value): void {
        $this->getBackingStore()->set('inboundMonthlyTotalUsers', $value);
    }
    ...
    */
    public function setOutboundMonthlyTotalUsers(?string $value): void {
        $this->getBackingStore()->set('outboundMonthlyTotalUsers', $value);
    }

...
*/
class TeleconferenceDeviceMediaQuality_maximumOutboundPacketLossRateInPercentage implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new TeleconferenceDeviceMediaQuality_maximumOutboundPacketLossRateInPercentage and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): TeleconferenceDeviceMediaQuality_maximumOutboundPacketLossRateInPercentage {
        $result = new TeleconferenceDeviceMediaQuality_maximumOutboundPacketLossRateInPercentage();

...
class OnTokenIssuanceStartReturnClaim implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): OnTokenIssuanceStartReturnClaim {
    ...
    */
    public function getClaimIdInApiResponse(): ?string {
        $val = $this->getBackingStore()->get('claimIdInApiResponse');
        if (is_null($val) || is_string($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'claimIdInApiResponse'");
    }
    ...
    */
    public function getFieldDeserializers(): array {
        $o = $this;
        return  [
            'claimIdInApiResponse' => fn(ParseNode $n) => $o->setClaimIdInApiResponse($n->getStringValue()),
    ...
    */
    public function setClaimIdInApiResponse(?string $value): void {
        $this->getBackingStore()->set('claimIdInApiResponse', $value);
    }

...
class WebauthnPublicKeyCredentialParameters implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): WebauthnPublicKeyCredentialParameters {
    ...
    */
    public function getAlg(): ?int {
        $val = $this->getBackingStore()->get('alg');
        if (is_null($val) || is_int($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'alg'");
    }
    ...
    */
    public function getFieldDeserializers(): array {
        $o = $this;
        return  [
            'alg' => fn(ParseNode $n) => $o->setAlg($n->getIntegerValue()),
    ...
    */
    public function setAlg(?int $value): void {
        $this->getBackingStore()->set('alg', $value);
    }

...
*/
class TeleconferenceDeviceVideoQuality_averageInboundFrameRate implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new TeleconferenceDeviceVideoQuality_averageInboundFrameRate and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): TeleconferenceDeviceVideoQuality_averageInboundFrameRate {
        $result = new TeleconferenceDeviceVideoQuality_averageInboundFrameRate();

...
class CloudFlareRulesetModel implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function getPhaseName(): ?string {
        $val = $this->getBackingStore()->get('phaseName');
        if (is_null($val) || is_string($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'phaseName'");
    }
    ...
    */
    public function getRulesetId(): ?string {
        $val = $this->getBackingStore()->get('rulesetId');
        if (is_null($val) || is_string($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'rulesetId'");
    }
    ...
    */
    public function setPhaseName(?string $value): void {
        $this->getBackingStore()->set('phaseName', $value);
    }
    ...
    */
    public function setRulesetId(?string $value): void {
        $this->getBackingStore()->set('rulesetId', $value);
    }

...
class WorkspaceCollectionResponse extends BaseCollectionPaginationCountResponse implements Parsable 
{
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): WorkspaceCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            'value' => fn(ParseNode $n) => $o->setValue($n->getCollectionOfObjectValues([Workspace::class, 'createFromDiscriminatorValue'])),
        ]);
    }
    ...
    */
     ...
     * @param array<Workspace>|null $value Value to set for the value property.
    */

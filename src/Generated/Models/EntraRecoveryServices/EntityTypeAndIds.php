...
class EntityTypeAndIds implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function getEntityIds(): ?array {
        $val = $this->getBackingStore()->get('entityIds');
        if (is_array($val) || is_null($val)) {
            TypeUtils::validateCollectionValues($val, 'string');
            /** @var array<string>|null $val */
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'entityIds'");
    }
    ...
    */
    public function setEntityIds(?array $value): void {
        $this->getBackingStore()->set('entityIds', $value);
    }

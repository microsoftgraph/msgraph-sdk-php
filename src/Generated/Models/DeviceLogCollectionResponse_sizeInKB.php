...
*/
class DeviceLogCollectionResponse_sizeInKB implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new DeviceLogCollectionResponse_sizeInKB and sets the default values.
    */

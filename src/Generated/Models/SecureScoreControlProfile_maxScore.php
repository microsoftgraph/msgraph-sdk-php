...
*/
class SecureScoreControlProfile_maxScore implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new SecureScoreControlProfile_maxScore and sets the default values.
    */
     ...
     * @return SecureScoreControlProfile_maxScore
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): SecureScoreControlProfile_maxScore {
        $result = new SecureScoreControlProfile_maxScore();

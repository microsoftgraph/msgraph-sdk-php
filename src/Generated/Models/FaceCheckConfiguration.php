...
class FaceCheckConfiguration implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function getSourcePhotoClaimName(): ?string {
        $val = $this->getBackingStore()->get('sourcePhotoClaimName');
        if (is_null($val) || is_string($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'sourcePhotoClaimName'");
    }
    ...
    */
    public function setSourcePhotoClaimName(?string $value): void {
        $this->getBackingStore()->set('sourcePhotoClaimName', $value);
    }

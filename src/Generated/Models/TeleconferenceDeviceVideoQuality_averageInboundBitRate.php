...
*/
class TeleconferenceDeviceVideoQuality_averageInboundBitRate implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new TeleconferenceDeviceVideoQuality_averageInboundBitRate and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): TeleconferenceDeviceVideoQuality_averageInboundBitRate {
        $result = new TeleconferenceDeviceVideoQuality_averageInboundBitRate();

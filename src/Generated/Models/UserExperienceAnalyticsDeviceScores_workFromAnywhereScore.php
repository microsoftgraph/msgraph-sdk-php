...
*/
class UserExperienceAnalyticsDeviceScores_workFromAnywhereScore implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new UserExperienceAnalyticsDeviceScores_workFromAnywhereScore and sets the default values.
    */
     ...
     * @return UserExperienceAnalyticsDeviceScores_workFromAnywhereScore
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): UserExperienceAnalyticsDeviceScores_workFromAnywhereScore {
        $result = new UserExperienceAnalyticsDeviceScores_workFromAnywhereScore();

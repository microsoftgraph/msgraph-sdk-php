...
*/
class Photo_fNumber implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new Photo_fNumber and sets the default values.
    */
     ...
     * @return Photo_fNumber
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): Photo_fNumber {
        $result = new Photo_fNumber();

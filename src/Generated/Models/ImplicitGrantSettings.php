...
class ImplicitGrantSettings implements AdditionalDataHolder, BackedModel, Parsable 
{
    ...
    */
    public function getEnableAccessTokenIssuance(): ?bool {
        $val = $this->getBackingStore()->get('enableAccessTokenIssuance');
        if (is_null($val) || is_bool($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'enableAccessTokenIssuance'");
    }
    ...
    */
    public function getEnableIdTokenIssuance(): ?bool {
        $val = $this->getBackingStore()->get('enableIdTokenIssuance');
        if (is_null($val) || is_bool($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'enableIdTokenIssuance'");
    }

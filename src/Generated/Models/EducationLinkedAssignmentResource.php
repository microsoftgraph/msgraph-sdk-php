...
class EducationLinkedAssignmentResource extends EducationResource implements Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): EducationLinkedAssignmentResource {

...
*/
class SecureScore_currentScore implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new SecureScore_currentScore and sets the default values.
    */
     ...
     * @return SecureScore_currentScore
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): SecureScore_currentScore {

...
class AcronymCollectionResponse extends BaseCollectionPaginationCountResponse implements Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): AcronymCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            'value' => fn(ParseNode $n) => $o->setValue($n->getCollectionOfObjectValues([Acronym::class, 'createFromDiscriminatorValue'])),
        ]);
    }

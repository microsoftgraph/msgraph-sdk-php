...
class WebauthnCredentialCreationOptions implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): WebauthnCredentialCreationOptions {
    ...
    */
    public function getChallengeTimeoutDateTime(): ?DateTime {
        $val = $this->getBackingStore()->get('challengeTimeoutDateTime');
        if (is_null($val) || $val instanceof DateTime) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'challengeTimeoutDateTime'");
    }
    ...
    */
    public function getFieldDeserializers(): array {
        $o = $this;
        return  [
            'challengeTimeoutDateTime' => fn(ParseNode $n) => $o->setChallengeTimeoutDateTime($n->getDateTimeValue()),
            '@odata.type' => fn(ParseNode $n) => $o->setOdataType($n->getStringValue()),
            'publicKey' => fn(ParseNode $n) => $o->setPublicKey($n->getObjectValue([WebauthnPublicKeyCredentialCreationOptions::class, 'createFromDiscriminatorValue'])),
        ];
    }
    ...
    */
    public function getPublicKey(): ?WebauthnPublicKeyCredentialCreationOptions {
        ...
        if (is_null($val) || $val instanceof WebauthnPublicKeyCredentialCreationOptions) {
            return $val;
        }
    ...
    */
    public function serialize(SerializationWriter $writer): void {
        $writer->writeDateTimeValue('challengeTimeoutDateTime', $this->getChallengeTimeoutDateTime());
    ...
    */
    public function setChallengeTimeoutDateTime(?DateTime $value): void {
        $this->getBackingStore()->set('challengeTimeoutDateTime', $value);
    }

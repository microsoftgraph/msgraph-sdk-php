...
*/
class RelyingPartyDetailedSummary_signInSuccessRate implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new RelyingPartyDetailedSummary_signInSuccessRate and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): RelyingPartyDetailedSummary_signInSuccessRate {
        $result = new RelyingPartyDetailedSummary_signInSuccessRate();

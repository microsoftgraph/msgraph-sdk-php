...
*/
class UserExperienceAnalyticsDevicePerformance_modelStartupPerformanceScore implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new UserExperienceAnalyticsDevicePerformance_modelStartupPerformanceScore and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): UserExperienceAnalyticsDevicePerformance_modelStartupPerformanceScore {
        $result = new UserExperienceAnalyticsDevicePerformance_modelStartupPerformanceScore();

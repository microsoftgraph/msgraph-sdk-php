...
*/
class Trending_weight implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new Trending_weight and sets the default values.
    */
     ...
     * @return Trending_weight
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): Trending_weight {
        $result = new Trending_weight();

...
class AuthenticationMethodsRegistrationCampaignIncludeTarget implements AdditionalDataHolder, BackedModel, Parsable 
{
    ...
    */
    public function getTargetedAuthenticationMethod(): ?string {
        $val = $this->getBackingStore()->get('targetedAuthenticationMethod');
        if (is_null($val) || is_string($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'targetedAuthenticationMethod'");
    }

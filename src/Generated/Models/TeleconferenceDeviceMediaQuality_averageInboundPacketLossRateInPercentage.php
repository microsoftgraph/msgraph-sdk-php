...
*/
class TeleconferenceDeviceMediaQuality_averageInboundPacketLossRateInPercentage implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new TeleconferenceDeviceMediaQuality_averageInboundPacketLossRateInPercentage and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): TeleconferenceDeviceMediaQuality_averageInboundPacketLossRateInPercentage {
        $result = new TeleconferenceDeviceMediaQuality_averageInboundPacketLossRateInPercentage();

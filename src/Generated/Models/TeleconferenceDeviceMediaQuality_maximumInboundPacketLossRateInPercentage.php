...
*/
class TeleconferenceDeviceMediaQuality_maximumInboundPacketLossRateInPercentage implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new TeleconferenceDeviceMediaQuality_maximumInboundPacketLossRateInPercentage and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): TeleconferenceDeviceMediaQuality_maximumInboundPacketLossRateInPercentage {
        $result = new TeleconferenceDeviceMediaQuality_maximumInboundPacketLossRateInPercentage();

...
*/
class RecommendedAction_potentialScoreImpact implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new RecommendedAction_potentialScoreImpact and sets the default values.
    */

...
class WorkflowExecutionConditions implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): WorkflowExecutionConditions {

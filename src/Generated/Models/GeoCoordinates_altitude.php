...
*/
class GeoCoordinates_altitude implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new GeoCoordinates_altitude and sets the default values.
    */
     ...
     * @return GeoCoordinates_altitude
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): GeoCoordinates_altitude {
        $result = new GeoCoordinates_altitude();

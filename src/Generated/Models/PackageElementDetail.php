...
class PackageElementDetail implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function getElements(): ?array {
        $val = $this->getBackingStore()->get('elements');
        if (is_array($val) || is_null($val)) {
            TypeUtils::validateCollectionValues($val, PackageElement::class);
            /** @var array<PackageElement>|null $val */
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'elements'");
    }
    ...
    */
    public function getElementType(): ?string {
        $val = $this->getBackingStore()->get('elementType');
        if (is_null($val) || is_string($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'elementType'");
    }
    ...
    */
    public function setElements(?array $value): void {
        $this->getBackingStore()->set('elements', $value);
    }
    ...
    */
    public function setElementType(?string $value): void {
        $this->getBackingStore()->set('elementType', $value);
    }

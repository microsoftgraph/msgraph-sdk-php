...
*/
class WorkbookChart_width implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new WorkbookChart_width and sets the default values.
    */
     ...
     * @return WorkbookChart_width
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): WorkbookChart_width {
        $result = new WorkbookChart_width();

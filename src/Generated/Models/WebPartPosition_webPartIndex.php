...
*/
class WebPartPosition_webPartIndex implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new WebPartPosition_webPartIndex and sets the default values.
    */
     ...
     * @return WebPartPosition_webPartIndex
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): WebPartPosition_webPartIndex {
        $result = new WebPartPosition_webPartIndex();

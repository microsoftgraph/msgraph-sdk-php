...
*/
class ScoredEmailAddress_relevanceScore implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new ScoredEmailAddress_relevanceScore and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): ScoredEmailAddress_relevanceScore {
        $result = new ScoredEmailAddress_relevanceScore();

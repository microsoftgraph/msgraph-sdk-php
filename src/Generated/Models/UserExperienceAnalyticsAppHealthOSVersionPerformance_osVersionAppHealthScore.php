...
*/
class UserExperienceAnalyticsAppHealthOSVersionPerformance_osVersionAppHealthScore implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new UserExperienceAnalyticsAppHealthOSVersionPerformance_osVersionAppHealthScore and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): UserExperienceAnalyticsAppHealthOSVersionPerformance_osVersionAppHealthScore {
        $result = new UserExperienceAnalyticsAppHealthOSVersionPerformance_osVersionAppHealthScore();

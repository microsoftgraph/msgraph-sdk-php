...
*/
class UserExperienceAnalyticsWorkFromAnywhereDevice_windowsScore implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new UserExperienceAnalyticsWorkFromAnywhereDevice_windowsScore and sets the default values.
    */
     ...
     * @return UserExperienceAnalyticsWorkFromAnywhereDevice_windowsScore
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): UserExperienceAnalyticsWorkFromAnywhereDevice_windowsScore {
        $result = new UserExperienceAnalyticsWorkFromAnywhereDevice_windowsScore();

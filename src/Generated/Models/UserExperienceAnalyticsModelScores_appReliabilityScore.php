...
*/
class UserExperienceAnalyticsModelScores_appReliabilityScore implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new UserExperienceAnalyticsModelScores_appReliabilityScore and sets the default values.
    */
     ...
     * @return UserExperienceAnalyticsModelScores_appReliabilityScore
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): UserExperienceAnalyticsModelScores_appReliabilityScore {
        $result = new UserExperienceAnalyticsModelScores_appReliabilityScore();

...
class WorkbookRangeFont extends Entity implements Parsable 
{
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            ...
            'size' => fn(ParseNode $n) => $o->setSize($n->getObjectValue([WorkbookRangeFont_size::class, 'createFromDiscriminatorValue'])),
    ...
    */
     ...
     * @return WorkbookRangeFont_size|null
    */
    public function getSize(): ?WorkbookRangeFont_size {
        $val = $this->getBackingStore()->get('size');
        if (is_null($val) || $val instanceof WorkbookRangeFont_size) {
            return $val;
        }
    ...
    */
     ...
     * @param WorkbookRangeFont_size|null $value Value to set for the size property.
    */
    public function setSize(?WorkbookRangeFont_size $value): void {

...
*/
class UserExperienceAnalyticsWorkFromAnywhereModelPerformance_cloudProvisioningScore implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new UserExperienceAnalyticsWorkFromAnywhereModelPerformance_cloudProvisioningScore and sets the default values.
    */
     ...
     * @return UserExperienceAnalyticsWorkFromAnywhereModelPerformance_cloudProvisioningScore
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): UserExperienceAnalyticsWorkFromAnywhereModelPerformance_cloudProvisioningScore {
        $result = new UserExperienceAnalyticsWorkFromAnywhereModelPerformance_cloudProvisioningScore();

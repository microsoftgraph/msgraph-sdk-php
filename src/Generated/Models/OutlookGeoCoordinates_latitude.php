...
*/
class OutlookGeoCoordinates_latitude implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new OutlookGeoCoordinates_latitude and sets the default values.
    */
     ...
     * @return OutlookGeoCoordinates_latitude
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): OutlookGeoCoordinates_latitude {
        $result = new OutlookGeoCoordinates_latitude();

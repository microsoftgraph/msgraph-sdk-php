...
class EmailSettings implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): EmailSettings {
    ...
    */
    public function getSenderDomain(): ?string {
        $val = $this->getBackingStore()->get('senderDomain');
        if (is_null($val) || is_string($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'senderDomain'");
    }
     ...
     * @return bool|null
    */
    public function getUseCompanyBranding(): ?bool {
        $val = $this->getBackingStore()->get('useCompanyBranding');
        if (is_null($val) || is_bool($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'useCompanyBranding'");
    }
    ...
    */
     ...
     * @param bool|null $value Value to set for the useCompanyBranding property.
    */
    public function setUseCompanyBranding(?bool $value): void {

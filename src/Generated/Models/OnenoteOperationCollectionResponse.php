...
class OnenoteOperationCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): OnenoteOperationCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($o) { $o->setValue($n->getCollectionOfObjectValues(array(OnenoteOperation::class, 'createFromDiscriminatorValue'))); },
        ];
    }

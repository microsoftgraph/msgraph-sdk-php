...
*/
class WorkbookChart_top implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new WorkbookChart_top and sets the default values.
    */
     ...
     * @return WorkbookChart_top
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): WorkbookChart_top {
        $result = new WorkbookChart_top();

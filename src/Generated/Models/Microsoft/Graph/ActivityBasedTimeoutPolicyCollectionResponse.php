...
class ActivityBasedTimeoutPolicyCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<ActivityBasedTimeoutPolicy>|null $value  */
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(ActivityBasedTimeoutPolicy::class)); },
        ];
    }

...
class UserScopeTeamsAppInstallationCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<UserScopeTeamsAppInstallation>|null $value  */
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(UserScopeTeamsAppInstallation::class)); },
        ];
    }

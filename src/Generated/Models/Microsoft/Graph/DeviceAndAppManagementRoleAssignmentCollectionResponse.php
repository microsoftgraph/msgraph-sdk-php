...
class DeviceAndAppManagementRoleAssignmentCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<DeviceAndAppManagementRoleAssignment>|null $value  */
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(DeviceAndAppManagementRoleAssignment::class)); },
        ];
    }

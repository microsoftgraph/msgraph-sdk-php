...
class DeviceManagementExportJobCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<DeviceManagementExportJob>|null $value  */
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(DeviceManagementExportJob::class)); },
        ];
    }

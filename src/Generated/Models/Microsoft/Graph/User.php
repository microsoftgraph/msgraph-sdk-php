...
class User extends DirectoryObject 
{
    ...
    /** @var array<Site>|null $followedSites  */
    ...
    /** @var array<OAuth2PermissionGrant>|null $oauth2PermissionGrants  */
    ...
    /** @var string|null $onPremisesSecurityIdentifier Contains the on-premises security identifier (SID) for the user that was synchronized from on-premises to the cloud. Read-only. Returned only on $select. Supports $filter (eq) on null values only. */
    ...
    */
    public function getFieldDeserializers(): array {
        return array_merge(parent::getFieldDeserializers(), [
            ...
            'externalUserStateChangeDateTime' => function (self $o, ParseNode $n) { $o->setExternalUserStateChangeDateTime($n->getDateTimeValue()); },
            ...
            'insights' => function (self $o, ParseNode $n) { $o->setInsights($n->getObjectValue(OfficeGraphInsights::class)); },

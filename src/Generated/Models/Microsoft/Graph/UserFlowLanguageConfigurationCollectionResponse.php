...
class UserFlowLanguageConfigurationCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<UserFlowLanguageConfiguration>|null $value  */
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(UserFlowLanguageConfiguration::class)); },
        ];
    }

...
class SecureScoreControlProfileCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<SecureScoreControlProfile>|null $value  */
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(SecureScoreControlProfile::class)); },
        ];
    }

...
class AuthenticationMethodConfigurationCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<AuthenticationMethodConfiguration>|null $value  */
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(AuthenticationMethodConfiguration::class)); },
        ];
    }

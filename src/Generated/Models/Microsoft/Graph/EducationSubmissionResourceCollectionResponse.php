...
class EducationSubmissionResourceCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<EducationSubmissionResource>|null $value  */
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(EducationSubmissionResource::class)); },
        ];
    }

...
class HomeRealmDiscoveryPolicyCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<HomeRealmDiscoveryPolicy>|null $value  */
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(HomeRealmDiscoveryPolicy::class)); },
        ];
    }

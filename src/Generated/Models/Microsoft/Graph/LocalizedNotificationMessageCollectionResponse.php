...
class LocalizedNotificationMessageCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<LocalizedNotificationMessage>|null $value  */
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(LocalizedNotificationMessage::class)); },
        ];
    }

...
class AttachmentCollectionResponse extends BaseCollectionPaginationCountResponse implements Parsable 
{
    /**
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            'value' => function (ParseNode $n) use ($o) { $o->setValue($n->getCollectionOfObjectValues(array(Attachment::class, 'createFromDiscriminatorValue'))); },
        ]);
    }

...
class DeviceComplianceScheduledActionForRuleCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): DeviceComplianceScheduledActionForRuleCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($o) { $o->setValue($n->getCollectionOfObjectValues(array(DeviceComplianceScheduledActionForRule::class, 'createFromDiscriminatorValue'))); },
        ];
    }

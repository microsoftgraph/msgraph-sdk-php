...
*/
class Photo_focalLength implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new Photo_focalLength and sets the default values.
    */
     ...
     * @return Photo_focalLength
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): Photo_focalLength {
        $result = new Photo_focalLength();

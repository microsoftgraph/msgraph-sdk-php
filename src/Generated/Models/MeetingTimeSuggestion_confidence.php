...
*/
class MeetingTimeSuggestion_confidence implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new MeetingTimeSuggestion_confidence and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): MeetingTimeSuggestion_confidence {
        $result = new MeetingTimeSuggestion_confidence();

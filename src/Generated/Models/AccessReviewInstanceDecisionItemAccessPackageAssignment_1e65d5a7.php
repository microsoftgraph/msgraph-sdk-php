...
*/
class AccessReviewInstanceDecisionItemAccessPackageAssignment_1e65d5a7 extends AccessReviewInstanceDecisionItemResource implements Parsable 
{
    /**
     * Instantiates a new AccessReviewInstanceDecisionItemAccessPackageAssignment_1e65d5a7 and sets the default values.
    */
     ...
     * @return AccessReviewInstanceDecisionItemAccessPackageAssignment_1e65d5a7
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): AccessReviewInstanceDecisionItemAccessPackageAssignment_1e65d5a7 {
        return new AccessReviewInstanceDecisionItemAccessPackageAssignment_1e65d5a7();
    }

...
*/
class UserExperienceAnalyticsDevicePerformance_averageRestarts implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new UserExperienceAnalyticsDevicePerformance_averageRestarts and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): UserExperienceAnalyticsDevicePerformance_averageRestarts {
        $result = new UserExperienceAnalyticsDevicePerformance_averageRestarts();

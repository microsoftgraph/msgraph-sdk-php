...
class AppManagementPolicyActorExemptions implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function getCustomSecurityAttributes(): ?array {
        ...
        if (is_array($val) || is_null($val)) {
            TypeUtils::validateCollectionValues($val, CustomSecurityAttributeExemption::class);
            /** @var array<CustomSecurityAttributeExemption>|null $val */
            return $val;
        }

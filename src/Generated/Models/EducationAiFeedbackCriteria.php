...
class EducationAiFeedbackCriteria implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function getAiFeedbackSettings(): ?EducationAiFeedbackSettings {
        $val = $this->getBackingStore()->get('aiFeedbackSettings');
        if (is_null($val) || $val instanceof EducationAiFeedbackSettings) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'aiFeedbackSettings'");
    }
    ...
    */
    public function getSpeechType(): ?EducationSpeechType {
        $val = $this->getBackingStore()->get('speechType');
        if (is_null($val) || $val instanceof EducationSpeechType) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'speechType'");
    }
    ...
    */
    public function setAiFeedbackSettings(?EducationAiFeedbackSettings $value): void {
        $this->getBackingStore()->set('aiFeedbackSettings', $value);
    }
    ...
    */
    public function setSpeechType(?EducationSpeechType $value): void {
        $this->getBackingStore()->set('speechType', $value);
    }

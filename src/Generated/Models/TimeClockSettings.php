...
class TimeClockSettings implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): TimeClockSettings {
    ...
    */
    public function getApprovedLocation(): ?GeoCoordinates {
        $val = $this->getBackingStore()->get('approvedLocation');
        if (is_null($val) || $val instanceof GeoCoordinates) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'approvedLocation'");
    }
    ...
    */
    public function setApprovedLocation(?GeoCoordinates $value): void {
        $this->getBackingStore()->set('approvedLocation', $value);
    }

...
*/
class IdentityUserFlow_userFlowTypeVersion implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new IdentityUserFlow_userFlowTypeVersion and sets the default values.
    */
     ...
     * @return IdentityUserFlow_userFlowTypeVersion
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): IdentityUserFlow_userFlowTypeVersion {
        $result = new IdentityUserFlow_userFlowTypeVersion();

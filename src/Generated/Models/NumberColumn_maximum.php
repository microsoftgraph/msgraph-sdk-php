...
*/
class NumberColumn_maximum implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new NumberColumn_maximum and sets the default values.
    */
     ...
     * @return NumberColumn_maximum
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): NumberColumn_maximum {
        $result = new NumberColumn_maximum();

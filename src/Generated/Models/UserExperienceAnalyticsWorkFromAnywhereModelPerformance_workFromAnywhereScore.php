...
*/
class UserExperienceAnalyticsWorkFromAnywhereModelPerformance_workFromAnywhereScore implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new UserExperienceAnalyticsWorkFromAnywhereModelPerformance_workFromAnywhereScore and sets the default values.
    */
     ...
     * @return UserExperienceAnalyticsWorkFromAnywhereModelPerformance_workFromAnywhereScore
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): UserExperienceAnalyticsWorkFromAnywhereModelPerformance_workFromAnywhereScore {
        $result = new UserExperienceAnalyticsWorkFromAnywhereModelPerformance_workFromAnywhereScore();

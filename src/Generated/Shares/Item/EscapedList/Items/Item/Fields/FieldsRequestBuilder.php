...
class FieldsRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/shares/{sharedDriveItem%2Did}/list/items/{listItem%2Did}/fields');
    ...
    */
    public function toGetRequestInformation(?FieldsRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/shares/{sharedDriveItem%2Did}/list/items/{listItem%2Did}/fields{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;

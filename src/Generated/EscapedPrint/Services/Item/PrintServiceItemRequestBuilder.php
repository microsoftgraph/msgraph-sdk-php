...
class PrintServiceItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $printServiceId key: id of printService
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $printServiceId = null) {
        $this->urlTemplate = '{+baseurl}/print/services/{printService%2Did}{?%24select,%24expand}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['printServiceId'] = $printServiceId;

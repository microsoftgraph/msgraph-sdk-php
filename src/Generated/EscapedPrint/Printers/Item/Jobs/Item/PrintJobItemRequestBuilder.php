...
class PrintJobItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/print/printers/{printer%2Did}/jobs/{printJob%2Did}');
    ...
    */
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/printjob-get?view=graph-rest-1.0 Find more info here
    */
     ...
     * @return Promise<PrintJob|null>
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/printjob-update?view=graph-rest-1.0 Find more info here
    */
    ...
    */
    public function toGetRequestInformation(?PrintJobItemRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/print/printers/{printer%2Did}/jobs/{printJob%2Did}{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;

...
namespace Microsoft\Graph\Generated\Sites\Item\GetByPathWithPath\Drive;
...
class DriveRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/sites/{site%2Did}/getByPath(path=\'{path}\')/drive{?%24expand,%24select}');

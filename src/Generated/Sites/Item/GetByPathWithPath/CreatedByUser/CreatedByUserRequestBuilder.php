...
namespace Microsoft\Graph\Generated\Sites\Item\GetByPathWithPath\CreatedByUser;
...
class CreatedByUserRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/sites/{site%2Did}/getByPath(path=\'{path}\')/createdByUser{?%24expand,%24select}');

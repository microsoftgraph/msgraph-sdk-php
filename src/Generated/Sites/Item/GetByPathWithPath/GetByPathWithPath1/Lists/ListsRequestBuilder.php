...
namespace Microsoft\Graph\Generated\Sites\Item\GetByPathWithPath\GetByPathWithPath1\Lists;
...
class ListsRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/sites/{site%2Did}/getByPath(path=\'{path}\')/getByPath(path=\'{path1}\')/lists{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}');

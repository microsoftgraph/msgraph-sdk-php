...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: LocalizedNotificationMessageItemRequestBuilderGetRequestConfiguration
*/
class LocalizedNotificationMessageItemRequestBuilderGetReques_c787a4a8 extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new LocalizedNotificationMessageItemRequestBuilderGetReques_c787a4a8 and sets the default values.

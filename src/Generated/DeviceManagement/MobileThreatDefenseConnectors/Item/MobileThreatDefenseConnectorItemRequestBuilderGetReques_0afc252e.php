...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: MobileThreatDefenseConnectorItemRequestBuilderGetRequestConfiguration
*/
class MobileThreatDefenseConnectorItemRequestBuilderGetReques_0afc252e extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new MobileThreatDefenseConnectorItemRequestBuilderGetReques_0afc252e and sets the default values.
    ...
    */
    public static function createQueryParameters(?array $expand = null, ?array $select = null): MobileThreatDefenseConnectorItemRequestBuilderGetQueryParameters {

...
class SyncRequestBuilder 
{
    ...
    */
    ...
    /**
     * Invoke action sync
     * @param SyncPostRequestBody $body 
     * @param array<string, mixed>|null $requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @return RequestInformation
    */
    public function createPostRequestInformation(SyncPostRequestBody $body, ?SyncRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
     ...
     * @return Promise
    */
    public function post(SyncPostRequestBody $body, ?SyncRequestBuilderPostRequestConfiguration $requestConfiguration = null, ?ResponseHandler $responseHandler = null): Promise {

...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: TermsAndConditionsAssignmentItemRequestBuilderGetRequestConfiguration
*/
class TermsAndConditionsAssignmentItemRequestBuilderGetReques_7a9821e0 extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new TermsAndConditionsAssignmentItemRequestBuilderGetReques_7a9821e0 and sets the default values.

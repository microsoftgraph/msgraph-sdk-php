...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: DeviceComplianceUserStatusItemRequestBuilderGetRequestConfiguration
*/
class DeviceComplianceUserStatusItemRequestBuilderGetRequestC_5d8e05da extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new DeviceComplianceUserStatusItemRequestBuilderGetRequestC_5d8e05da and sets the default values.

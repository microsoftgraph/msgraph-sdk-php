...
class DeviceCompliancePolicyAssignmentItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $deviceCompliancePolicyAssignmentId key: id of deviceCompliancePolicyAssignment
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $deviceCompliancePolicyAssignmentId = null) {
        ...
        $urlTplParams['deviceCompliancePolicyAssignmentId'] = $deviceCompliancePolicyAssignmentId;

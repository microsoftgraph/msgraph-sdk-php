...
class ScheduleActionsForRulesRequestBuilder 
{
    ...
    */
     ...
     * @param ScheduleActionsForRulesPostRequestBody $body 
    ...
    */
    public function createPostRequestInformation(ScheduleActionsForRulesPostRequestBody $body, ?ScheduleActionsForRulesRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
     ...
     * @return Promise
    */
    public function post(ScheduleActionsForRulesPostRequestBody $body, ?ScheduleActionsForRulesRequestBuilderPostRequestConfiguration $requestConfiguration = null, ?ResponseHandler $responseHandler = null): Promise {

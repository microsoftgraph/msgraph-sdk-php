...
class GetAuditActivityTypesWithCategoryRequestBuilder 
{
    ...
    */
    public function createGetRequestInformation(?GetAuditActivityTypesWithCategoryRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
     ...
     * @return Promise
    */
    public function get(?GetAuditActivityTypesWithCategoryRequestBuilderGetRequestConfiguration $requestConfiguration = null, ?ResponseHandler $responseHandler = null): Promise {
        ...
        try {
            ...
            return $this->requestAdapter->sendAsync($requestInfo, [GetAuditActivityTypesWithCategoryResponse::class, 'createFromDiscriminatorValue'], $responseHandler, $errorMappings);
        } catch(Exception $ex) {

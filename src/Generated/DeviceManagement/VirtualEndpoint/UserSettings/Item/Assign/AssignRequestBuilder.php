...
namespace Microsoft\\Graph\\Generated\DeviceManagement\VirtualEndpoint\UserSettings\Item\Assign;
...
class AssignRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceManagement/virtualEndpoint/userSettings/{cloudPcUserSetting%2Did}/assign');
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/cloudpcusersetting-assign?view=graph-rest-1.0 Find more info here
    */

...
*/
class GetSourceImagesRequestBuilderGetRequestConfiguration extends BaseRequestConfiguration 
{
    /**
    ...
    */
    public static function createQueryParameters(?bool $count = null, ?string $filter = null, ?string $search = null, ?int $skip = null, ?int $top = null): GetSourceImagesRequestBuilderGetQueryParameters {

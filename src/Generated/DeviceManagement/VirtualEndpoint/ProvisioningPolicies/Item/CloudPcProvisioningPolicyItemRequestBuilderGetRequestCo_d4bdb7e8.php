...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: CloudPcProvisioningPolicyItemRequestBuilderGetRequestConfiguration
*/
class CloudPcProvisioningPolicyItemRequestBuilderGetRequestCo_d4bdb7e8 extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new CloudPcProvisioningPolicyItemRequestBuilderGetRequestCo_d4bdb7e8 and sets the default values.

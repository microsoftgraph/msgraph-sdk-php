...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: CloudPcOnPremisesConnectionItemRequestBuilderGetRequestConfiguration
*/
class CloudPcOnPremisesConnectionItemRequestBuilderGetRequest_b4bc95fb extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new CloudPcOnPremisesConnectionItemRequestBuilderGetRequest_b4bc95fb and sets the default values.

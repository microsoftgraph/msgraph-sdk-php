...
namespace Microsoft\Graph\Generated\DeviceManagement\VirtualEndpoint\OnPremisesConnections\Item\UpdateAdDomainPassword;
...
class UpdateAdDomainPasswordRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
     ...
     * @return UpdateAdDomainPasswordRequestBuilder
    */
    public function withUrl(string $rawUrl): UpdateAdDomainPasswordRequestBuilder {
        return new UpdateAdDomainPasswordRequestBuilder($rawUrl, $this->requestAdapter);
    }

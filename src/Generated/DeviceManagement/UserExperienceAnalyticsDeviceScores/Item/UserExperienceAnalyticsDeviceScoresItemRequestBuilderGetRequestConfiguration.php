...
*/
class UserExperienceAnalyticsDeviceScoresItemRequestBuilderGetRequestConfiguration extends BaseRequestConfiguration 
{
    /**
     * @var UserExperienceAnalyticsDeviceScoresItemRequestBuilderGetQueryParameters|null $queryParameters Request query parameters
    */
     ...
     * @param UserExperienceAnalyticsDeviceScoresItemRequestBuilderGetQueryParameters|null $queryParameters Request query parameters
    */
    public function __construct(?array $headers = null, ?array $options = null, ?UserExperienceAnalyticsDeviceScoresItemRequestBuilderGetQueryParameters $queryParameters = null) {

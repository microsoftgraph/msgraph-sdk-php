...
*/
class UserExperienceAnalyticsDeviceScoresRequestBuilderGetRequestConfiguration extends BaseRequestConfiguration 
{
    /**
     * @var UserExperienceAnalyticsDeviceScoresRequestBuilderGetQueryParameters|null $queryParameters Request query parameters
    */

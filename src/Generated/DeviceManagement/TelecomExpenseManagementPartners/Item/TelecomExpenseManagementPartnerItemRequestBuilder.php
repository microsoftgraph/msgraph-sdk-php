...
class TelecomExpenseManagementPartnerItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $telecomExpenseManagementPartnerId key: id of telecomExpenseManagementPartner
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $telecomExpenseManagementPartnerId = null) {
        ...
        $urlTplParams['telecomExpenseManagementPartnerId'] = $telecomExpenseManagementPartnerId;

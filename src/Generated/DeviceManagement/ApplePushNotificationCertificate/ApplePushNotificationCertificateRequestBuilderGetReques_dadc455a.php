...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: applePushNotificationCertificateRequestBuilderGetRequestConfiguration
*/
class ApplePushNotificationCertificateRequestBuilderGetReques_dadc455a extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new ApplePushNotificationCertificateRequestBuilderGetReques_dadc455a and sets the default values.

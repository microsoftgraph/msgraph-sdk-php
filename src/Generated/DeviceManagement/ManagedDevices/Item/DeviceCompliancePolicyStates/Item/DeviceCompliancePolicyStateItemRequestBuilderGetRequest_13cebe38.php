...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: DeviceCompliancePolicyStateItemRequestBuilderGetRequestConfiguration
*/
class DeviceCompliancePolicyStateItemRequestBuilderGetRequest_13cebe38 extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new DeviceCompliancePolicyStateItemRequestBuilderGetRequest_13cebe38 and sets the default values.

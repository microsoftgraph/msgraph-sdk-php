...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: userExperienceAnalyticsOverviewRequestBuilderGetRequestConfiguration
*/
class UserExperienceAnalyticsOverviewRequestBuilderGetRequest_567170b1 extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new UserExperienceAnalyticsOverviewRequestBuilderGetRequest_567170b1 and sets the default values.

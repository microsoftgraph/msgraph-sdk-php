...
class PasswordCredentialPostRequestBody implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
     ...
     * @return PasswordCredentialPostRequestBody
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): PasswordCredentialPostRequestBody {

...
class WorkbookChartPointItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $workbookChartPointId key: id of workbookChartPoint
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $workbookChartPointId = null) {
        ...
        $urlTplParams['workbookChartPointId'] = $workbookChartPointId;

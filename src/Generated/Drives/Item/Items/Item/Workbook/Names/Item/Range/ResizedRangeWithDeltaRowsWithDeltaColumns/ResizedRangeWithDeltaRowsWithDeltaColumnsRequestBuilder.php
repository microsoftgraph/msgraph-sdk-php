...
namespace Microsoft\Graph\Generated\Drives\Item\Items\Item\Workbook\Names\Item\Range\ResizedRangeWithDeltaRowsWithDeltaColumns;
...
class ResizedRangeWithDeltaRowsWithDeltaColumnsRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?int $deltaColumns = null, ?int $deltaRows = null) {
        parent::__construct($requestAdapter, [], '{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/names/{workbookNamedItem%2Did}/range()/resizedRange(deltaRows={deltaRows},deltaColumns={deltaColumns})');

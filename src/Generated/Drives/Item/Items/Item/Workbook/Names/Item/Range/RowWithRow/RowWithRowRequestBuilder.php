...
namespace Microsoft\Graph\Generated\Drives\Item\Items\Item\Workbook\Names\Item\Range\RowWithRow;
...
class RowWithRowRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?int $row = null) {
        parent::__construct($requestAdapter, [], '{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/names/{workbookNamedItem%2Did}/range()/row(row={row})');

...
namespace Microsoft\\Graph\\Generated\Drives\Item\Items\Item\Workbook\Names\Item\Range\BoundingRectWithAnotherRange;
...
class BoundingRectWithAnotherRangeRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $anotherRange = null) {
        parent::__construct($requestAdapter, [], '{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/names/{workbookNamedItem%2Did}/range()/boundingRect(anotherRange=\'{anotherRange}\')');

...
namespace Microsoft\\Graph\\Generated\Drives\Item\Items\Item\Workbook\Tables\Item\Columns\Item\Range\OffsetRangeWithRowOffsetWithColumnOffset;
...
class OffsetRangeWithRowOffsetWithColumnOffsetRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?int $columnOffset = null, ?int $rowOffset = null) {
        parent::__construct($requestAdapter, [], '{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/tables/{workbookTable%2Did}/columns/{workbookTableColumn%2Did}/range()/offsetRange(rowOffset={rowOffset},columnOffset={columnOffset})');

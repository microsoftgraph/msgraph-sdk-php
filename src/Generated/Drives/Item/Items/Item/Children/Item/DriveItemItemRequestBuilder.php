...
class DriveItemItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $driveItemId1 key: id of driveItem
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $driveItemId1 = null) {
        ...
        $urlTplParams['driveItemId1'] = $driveItemId1;

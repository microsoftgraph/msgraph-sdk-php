...
namespace Microsoft\\Graph\\Generated\Drives\Item\EscapedList\Items\DeltaWithToken;
...
class DeltaWithTokenRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $token = null) {
        parent::__construct($requestAdapter, [], '{+baseurl}/drives/{drive%2Did}/list/items/delta(token=\'{token}\'){?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}');

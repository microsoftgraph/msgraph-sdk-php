...
class RoleEligibilityScheduleInstancesRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function toGetRequestInformation(?RoleEligibilityScheduleInstancesRequestBuilderGetReques_4ad01c2c $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/roleManagement/directory/roleEligibilityScheduleInstances{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}';

...
namespace Microsoft\Graph\Generated\Teamwork\DeletedTeams\Item\Channels\GetAllRetainedMessages;
...
*/
class GetAllRetainedMessagesRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/teamwork/deletedTeams/{deletedTeam%2Did}/channels/getAllRetainedMessages(){?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}');
    ...
    */
    public function toGetRequestInformation(?GetAllRetainedMessagesRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
    ...
    */
    public function withUrl(string $rawUrl): GetAllRetainedMessagesRequestBuilder {
        return new GetAllRetainedMessagesRequestBuilder($rawUrl, $this->requestAdapter);
    }

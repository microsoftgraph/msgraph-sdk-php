...
*/
class UndoDeleteRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/teamwork/deletedChats/{deletedChat%2Did}/undoDelete');
    ...
    */
    public function toPostRequestInformation(?UndoDeleteRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
     ...
     * @return UndoDeleteRequestBuilder
    */
    public function withUrl(string $rawUrl): UndoDeleteRequestBuilder {
        return new UndoDeleteRequestBuilder($rawUrl, $this->requestAdapter);
    }

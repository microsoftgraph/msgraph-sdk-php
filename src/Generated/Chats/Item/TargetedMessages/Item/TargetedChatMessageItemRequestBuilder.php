...
use Microsoft\Graph\Generated\Chats\Item\TargetedMessages\Item\HostedContents\HostedContentsRequestBuilder;
use Microsoft\Graph\Generated\Chats\Item\TargetedMessages\Item\Replies\RepliesRequestBuilder;
...
class TargetedChatMessageItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/chats/{chat%2Did}/targetedMessages/{targetedChatMessage%2Did}');
    ...
    */
    public function toGetRequestInformation(?TargetedChatMessageItemRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/chats/{chat%2Did}/targetedMessages/{targetedChatMessage%2Did}{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;

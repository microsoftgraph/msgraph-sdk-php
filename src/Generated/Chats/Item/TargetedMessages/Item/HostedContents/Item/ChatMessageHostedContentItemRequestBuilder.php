...
namespace Microsoft\Graph\Generated\Chats\Item\TargetedMessages\Item\HostedContents\Item;

use Exception;
use Http\Promise\Promise;
use Microsoft\Graph\Generated\Chats\Item\TargetedMessages\Item\HostedContents\Item\Value\ContentRequestBuilder;
...
class ChatMessageHostedContentItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/chats/{chat%2Did}/targetedMessages/{targetedChatMessage%2Did}/hostedContents/{chatMessageHostedContent%2Did}');
    ...
    */
    public function toGetRequestInformation(?ChatMessageHostedContentItemRequestBuilderGetRequestCon_96800328 $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/chats/{chat%2Did}/targetedMessages/{targetedChatMessage%2Did}/hostedContents/{chatMessageHostedContent%2Did}{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;

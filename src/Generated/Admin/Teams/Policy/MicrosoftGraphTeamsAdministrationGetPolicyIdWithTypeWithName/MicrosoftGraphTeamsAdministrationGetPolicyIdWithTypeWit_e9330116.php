...
*/
class MicrosoftGraphTeamsAdministrationGetPolicyIdWithTypeWit_e9330116 extends BaseRequestBuilder 
{
    /**
     * Instantiates a new MicrosoftGraphTeamsAdministrationGetPolicyIdWithTypeWit_e9330116 and sets the default values.
    ...
    */
     ...
     * @param MicrosoftGraphTeamsAdministrationGetPolicyIdWithTypeWit_f61b4263|null $requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
    ...
    */
    public function get(?MicrosoftGraphTeamsAdministrationGetPolicyIdWithTypeWit_f61b4263 $requestConfiguration = null): Promise {
    ...
    */
    public function toGetRequestInformation(?MicrosoftGraphTeamsAdministrationGetPolicyIdWithTypeWit_f61b4263 $requestConfiguration = null): RequestInformation {
    ...
    */
    public function withUrl(string $rawUrl): MicrosoftGraphTeamsAdministrationGetPolicyIdWithTypeWit_e9330116 {
        return new MicrosoftGraphTeamsAdministrationGetPolicyIdWithTypeWit_e9330116($rawUrl, $this->requestAdapter);
    }

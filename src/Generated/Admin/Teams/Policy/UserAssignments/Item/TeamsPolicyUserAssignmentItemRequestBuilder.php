...
*/
class TeamsPolicyUserAssignmentItemRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/admin/teams/policy/userAssignments/{teamsPolicyUserAssignment%2Did}');
    ...
    */
    public function toGetRequestInformation(?TeamsPolicyUserAssignmentItemRequestBuilderGetRequestCo_ed287caa $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/admin/teams/policy/userAssignments/{teamsPolicyUserAssignment%2Did}{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
    ...
    */
    public function withUrl(string $rawUrl): TeamsPolicyUserAssignmentItemRequestBuilder {
        return new TeamsPolicyUserAssignmentItemRequestBuilder($rawUrl, $this->requestAdapter);
    }

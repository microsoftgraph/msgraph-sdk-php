...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: TeamsPolicyUserAssignmentItemRequestBuilderGetRequestConfiguration
*/
class TeamsPolicyUserAssignmentItemRequestBuilderGetRequestCo_ed287caa extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new TeamsPolicyUserAssignmentItemRequestBuilderGetRequestCo_ed287caa and sets the default values.

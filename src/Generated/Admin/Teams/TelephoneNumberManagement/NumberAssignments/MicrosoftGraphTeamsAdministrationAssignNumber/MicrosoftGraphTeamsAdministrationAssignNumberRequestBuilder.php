...
*/
class MicrosoftGraphTeamsAdministrationAssignNumberRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/admin/teams/telephoneNumberManagement/numberAssignments/microsoft.graph.teamsAdministration.assignNumber');
    ...
    */
     ...
     * @return MicrosoftGraphTeamsAdministrationAssignNumberRequestBuilder
    */
    public function withUrl(string $rawUrl): MicrosoftGraphTeamsAdministrationAssignNumberRequestBuilder {
        return new MicrosoftGraphTeamsAdministrationAssignNumberRequestBuilder($rawUrl, $this->requestAdapter);
    }

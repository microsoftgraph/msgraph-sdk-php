...
namespace Microsoft\Graph\Generated\Admin\Teams\UserConfigurations\Item\User\ServiceProvisioningErrors;

use Exception;
use Http\Promise\Promise;
use Microsoft\Graph\Generated\Admin\Teams\UserConfigurations\Item\User\ServiceProvisioningErrors\Count\CountRequestBuilder;
...
class ServiceProvisioningErrorsRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/admin/teams/userConfigurations/{teamsUserConfiguration%2Did}/user/serviceProvisioningErrors{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}');

...
class UnfavoritePostResponse implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): UnfavoritePostResponse {

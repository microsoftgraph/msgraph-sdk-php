...
class AudioRoutingGroupItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $audioRoutingGroupId key: id of audioRoutingGroup
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $audioRoutingGroupId = null) {
        ...
        $urlTplParams['audioRoutingGroupId'] = $audioRoutingGroupId;

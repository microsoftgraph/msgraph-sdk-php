...
use Microsoft\Graph\Generated\Communications\OnlineMeetingConversations\Item\Starter\Reactions\Count\CountRequestBuilder;
use Microsoft\Graph\Generated\Communications\OnlineMeetingConversations\Item\Starter\Reactions\Item\EngagementConversationMessageReactionItemRequestBuilder;
...
class ReactionsRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function toGetRequestInformation(?ReactionsRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/communications/onlineMeetingConversations/{onlineMeetingEngagementConversation%2Did}/starter/reactions{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}';
    ...
    */
    public function toPostRequestInformation(EngagementConversationMessageReaction $body, ?ReactionsRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/communications/onlineMeetingConversations/{onlineMeetingEngagementConversation%2Did}/starter/reactions';
        $requestInfo->pathParameters = $this->pathParameters;

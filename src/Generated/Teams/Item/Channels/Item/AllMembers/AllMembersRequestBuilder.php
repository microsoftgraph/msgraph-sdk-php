...
namespace Microsoft\Graph\Generated\Teams\Item\Channels\Item\AllMembers;
...
use Microsoft\Graph\Generated\Teams\Item\Channels\Item\AllMembers\Add\AddRequestBuilder;
use Microsoft\Graph\Generated\Teams\Item\Channels\Item\AllMembers\Count\CountRequestBuilder;
use Microsoft\Graph\Generated\Teams\Item\Channels\Item\AllMembers\Item\ConversationMemberItemRequestBuilder;
use Microsoft\Graph\Generated\Teams\Item\Channels\Item\AllMembers\Remove\RemoveRequestBuilder;
...
class AllMembersRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/channel-list-allmembers?view=graph-rest-1.0 Find more info here
    */
    ...
    */
    public function toGetRequestInformation(?AllMembersRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/teams/{team%2Did}/channels/{channel%2Did}/allMembers{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}';
    ...
    */
    public function toPostRequestInformation(ConversationMember $body, ?AllMembersRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/teams/{team%2Did}/channels/{channel%2Did}/allMembers';
        $requestInfo->pathParameters = $this->pathParameters;

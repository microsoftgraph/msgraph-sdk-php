...
namespace Microsoft\Graph\Generated\Teams\Item\PrimaryChannel\AllMembers;
...
use Microsoft\Graph\Generated\Teams\Item\PrimaryChannel\AllMembers\Add\AddRequestBuilder;
use Microsoft\Graph\Generated\Teams\Item\PrimaryChannel\AllMembers\Count\CountRequestBuilder;
use Microsoft\Graph\Generated\Teams\Item\PrimaryChannel\AllMembers\Item\ConversationMemberItemRequestBuilder;
use Microsoft\Graph\Generated\Teams\Item\PrimaryChannel\AllMembers\Remove\RemoveRequestBuilder;
...
class AllMembersRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function toGetRequestInformation(?AllMembersRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/teams/{team%2Did}/primaryChannel/allMembers{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}';
    ...
    */
    public function toPostRequestInformation(ConversationMember $body, ?AllMembersRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/teams/{team%2Did}/primaryChannel/allMembers';
        $requestInfo->pathParameters = $this->pathParameters;

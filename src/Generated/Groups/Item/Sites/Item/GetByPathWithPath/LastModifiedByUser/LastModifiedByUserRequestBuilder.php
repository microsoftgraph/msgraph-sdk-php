...
namespace Microsoft\Graph\Generated\Groups\Item\Sites\Item\GetByPathWithPath\LastModifiedByUser;
...
class LastModifiedByUserRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/getByPath(path=\'{path}\')/lastModifiedByUser{?%24expand,%24select}');

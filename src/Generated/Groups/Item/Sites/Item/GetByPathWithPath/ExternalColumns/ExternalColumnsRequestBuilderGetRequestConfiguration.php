...
namespace Microsoft\Graph\Generated\Groups\Item\Sites\Item\GetByPathWithPath\ExternalColumns;
...
class ExternalColumnsRequestBuilderGetRequestConfiguration extends BaseRequestConfiguration 
{
    ...
    */
    public static function createQueryParameters(?bool $count = null, ?array $expand = null, ?string $filter = null, ?string $search = null, ?array $select = null, ?int $skip = null, ?int $top = null): ExternalColumnsRequestBuilderGetQueryParameters {
        return new ExternalColumnsRequestBuilderGetQueryParameters($count, $expand, $filter, $search, $select, $skip, $top);
    }

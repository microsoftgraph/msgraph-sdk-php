...
namespace Microsoft\Graph\Generated\Groups\Item\Sites\Item\GetByPathWithPath\TermStores;
...
class TermStoresRequestBuilderGetRequestConfiguration extends BaseRequestConfiguration 
{
    ...
    */
    public static function createQueryParameters(?bool $count = null, ?array $expand = null, ?string $filter = null, ?string $search = null, ?array $select = null, ?int $skip = null, ?int $top = null): TermStoresRequestBuilderGetQueryParameters {
        return new TermStoresRequestBuilderGetQueryParameters($count, $expand, $filter, $search, $select, $skip, $top);
    }

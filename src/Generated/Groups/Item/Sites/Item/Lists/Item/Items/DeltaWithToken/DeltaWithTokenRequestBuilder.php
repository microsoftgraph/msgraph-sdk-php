...
namespace Microsoft\Graph\Generated\Groups\Item\Sites\Item\Lists\Item\Items\DeltaWithToken;
...
class DeltaWithTokenRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $token = null) {
        parent::__construct($requestAdapter, [], '{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/lists/{list%2Did}/items/delta(token=\'{token}\'){?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}');

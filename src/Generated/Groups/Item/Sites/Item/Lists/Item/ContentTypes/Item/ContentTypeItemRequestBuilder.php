...
use Microsoft\Graph\Groups\Item\Sites\Item\Lists\Item\ContentTypes\Item\AssociateWithHubSites\AssociateWithHubSitesRequestBuilder;
use Microsoft\Graph\Groups\Item\Sites\Item\Lists\Item\ContentTypes\Item\Base\BaseRequestBuilder;
use Microsoft\Graph\Groups\Item\Sites\Item\Lists\Item\ContentTypes\Item\BaseTypes\BaseTypesRequestBuilder;
use Microsoft\Graph\Groups\Item\Sites\Item\Lists\Item\ContentTypes\Item\ColumnLinks\ColumnLinksRequestBuilder;
use Microsoft\Graph\Groups\Item\Sites\Item\Lists\Item\ContentTypes\Item\ColumnLinks\Item\ColumnLinkItemRequestBuilder;
use Microsoft\Graph\Groups\Item\Sites\Item\Lists\Item\ContentTypes\Item\ColumnPositions\ColumnPositionsRequestBuilder;
use Microsoft\Graph\Groups\Item\Sites\Item\Lists\Item\ContentTypes\Item\ColumnPositions\Item\ColumnDefinitionItemRequestBuilder as MicrosoftGraphGroupsItemSitesItemListsItemContentTypesItemColumnPositionsItemColumnDefinitionItemRequestBuilder;
use Microsoft\Graph\Groups\Item\Sites\Item\Lists\Item\ContentTypes\Item\Columns\ColumnsRequestBuilder;
use Microsoft\Graph\Groups\Item\Sites\Item\Lists\Item\ContentTypes\Item\Columns\Item\ColumnDefinitionItemRequestBuilder as MicrosoftGraphGroupsItemSitesItemListsItemContentTypesItemColumnsItemColumnDefinitionItemRequestBuilder;
use Microsoft\Graph\Groups\Item\Sites\Item\Lists\Item\ContentTypes\Item\CopyToDefaultContentLocation\CopyToDefaultContentLocationRequestBuilder;
use Microsoft\Graph\Groups\Item\Sites\Item\Lists\Item\ContentTypes\Item\IsPublished\IsPublishedRequestBuilder;
use Microsoft\Graph\Groups\Item\Sites\Item\Lists\Item\ContentTypes\Item\Publish\PublishRequestBuilder;
use Microsoft\Graph\Groups\Item\Sites\Item\Lists\Item\ContentTypes\Item\Unpublish\UnpublishRequestBuilder;
...
class ContentTypeItemRequestBuilder 
{
    ...
    */
     ...
     * @param string $id Unique identifier of the item
     * @return MicrosoftGraphGroupsItemSitesItemListsItemContentTypesItemColumnPositionsItemColumnDefinitionItemRequestBuilder
    */
    public function columnPositionsById(string $id): MicrosoftGraphGroupsItemSitesItemListsItemContentTypesItemColumnPositionsItemColumnDefinitionItemRequestBuilder {
        $urlTplParams = $this->pathParameters;
        $urlTplParams['columnDefinition%2Did'] = $id;
        return new MicrosoftGraphGroupsItemSitesItemListsItemContentTypesItemColumnPositionsItemColumnDefinitionItemRequestBuilder($urlTplParams, $this->requestAdapter);
    }

    /**
     * Gets an item from the Microsoft\Graph.groups.item.sites.item.lists.item.contentTypes.item.columns.item collection
     * @param string $id Unique identifier of the item
     * @return MicrosoftGraphGroupsItemSitesItemListsItemContentTypesItemColumnsItemColumnDefinitionItemRequestBuilder
    */
    public function columnsById(string $id): MicrosoftGraphGroupsItemSitesItemListsItemContentTypesItemColumnsItemColumnDefinitionItemRequestBuilder {
        $urlTplParams = $this->pathParameters;
        $urlTplParams['columnDefinition%2Did'] = $id;
        return new MicrosoftGraphGroupsItemSitesItemListsItemContentTypesItemColumnsItemColumnDefinitionItemRequestBuilder($urlTplParams, $this->requestAdapter);
    }

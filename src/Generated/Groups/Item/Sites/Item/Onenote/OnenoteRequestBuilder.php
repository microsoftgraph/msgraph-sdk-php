...
use Microsoft\Graph\Groups\Item\Sites\Item\Onenote\Notebooks\Item\NotebookItemRequestBuilder;
use Microsoft\Graph\Groups\Item\Sites\Item\Onenote\Notebooks\NotebooksRequestBuilder;
use Microsoft\Graph\Groups\Item\Sites\Item\Onenote\Operations\Item\OnenoteOperationItemRequestBuilder;
use Microsoft\Graph\Groups\Item\Sites\Item\Onenote\Operations\OperationsRequestBuilder;
use Microsoft\Graph\Groups\Item\Sites\Item\Onenote\Pages\Item\OnenotePageItemRequestBuilder;
use Microsoft\Graph\Groups\Item\Sites\Item\Onenote\Pages\PagesRequestBuilder;
use Microsoft\Graph\Groups\Item\Sites\Item\Onenote\Resources\Item\OnenoteResourceItemRequestBuilder;
use Microsoft\Graph\Groups\Item\Sites\Item\Onenote\Resources\ResourcesRequestBuilder;
use Microsoft\Graph\Groups\Item\Sites\Item\Onenote\SectionGroups\Item\SectionGroupItemRequestBuilder;
use Microsoft\Graph\Groups\Item\Sites\Item\Onenote\SectionGroups\SectionGroupsRequestBuilder;
use Microsoft\Graph\Groups\Item\Sites\Item\Onenote\Sections\Item\OnenoteSectionItemRequestBuilder;
use Microsoft\Graph\Groups\Item\Sites\Item\Onenote\Sections\SectionsRequestBuilder;
...
class OnenoteRequestBuilder 
{
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph.groups.item.sites.item.onenote.notebooks.item collection
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph.groups.item.sites.item.onenote.operations.item collection
     * @param string $id Unique identifier of the item
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph.groups.item.sites.item.onenote.pages.item collection
     * @param string $id Unique identifier of the item
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph.groups.item.sites.item.onenote.resources.item collection
     * @param string $id Unique identifier of the item
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph.groups.item.sites.item.onenote.sectionGroups.item collection
     * @param string $id Unique identifier of the item
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph.groups.item.sites.item.onenote.sections.item collection
     * @param string $id Unique identifier of the item

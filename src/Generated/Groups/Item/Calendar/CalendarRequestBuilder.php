...
class CalendarRequestBuilder 
{
    ...
    */
     ...
     * Provides operations to manage the calendarView property of the microsoft.graph.calendar entity.
     * @param string $id Unique identifier of the item
     * @return \Microsoft\Graph\Generated\Groups\Item\Calendar\CalendarView\Item\EventItemRequestBuilder|null
    */
    ...
    */
     ...
     * Provides operations to manage the events property of the microsoft.graph.calendar entity.
     * @param string $id Unique identifier of the item
     * @return \Microsoft\Graph\Generated\Groups\Item\Calendar\Events\Item\EventItemRequestBuilder|null
    */

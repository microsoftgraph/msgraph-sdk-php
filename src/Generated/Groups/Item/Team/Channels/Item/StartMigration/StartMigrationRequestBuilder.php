...
namespace Microsoft\Graph\Generated\Groups\Item\Team\Channels\Item\StartMigration;
...
class StartMigrationRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/groups/{group%2Did}/team/channels/{channel%2Did}/startMigration');
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/channel-startmigration?view=graph-rest-1.0 Find more info here
    */

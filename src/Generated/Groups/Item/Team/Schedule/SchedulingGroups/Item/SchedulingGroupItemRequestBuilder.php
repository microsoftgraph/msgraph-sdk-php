...
class SchedulingGroupItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $schedulingGroupId key: id of schedulingGroup
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $schedulingGroupId = null) {
        $this->urlTemplate = '{+baseurl}/groups/{group%2Did}/team/schedule/schedulingGroups/{schedulingGroup%2Did}{?%24select}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['schedulingGroupId'] = $schedulingGroupId;

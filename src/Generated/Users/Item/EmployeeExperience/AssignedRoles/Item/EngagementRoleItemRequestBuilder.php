...
namespace Microsoft\Graph\Generated\Users\Item\EmployeeExperience\AssignedRoles\Item;

use Exception;
use Http\Promise\Promise;
use Microsoft\Graph\Generated\Models\EngagementRole;
use Microsoft\Graph\Generated\Models\ODataErrors\ODataError;
use Microsoft\Graph\Generated\Users\Item\EmployeeExperience\AssignedRoles\Item\Members\MembersRequestBuilder;
...
class EngagementRoleItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/users/{user%2Did}/employeeExperience/assignedRoles/{engagementRole%2Did}');
    ...
    */
    public function toGetRequestInformation(?EngagementRoleItemRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/users/{user%2Did}/employeeExperience/assignedRoles/{engagementRole%2Did}{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;

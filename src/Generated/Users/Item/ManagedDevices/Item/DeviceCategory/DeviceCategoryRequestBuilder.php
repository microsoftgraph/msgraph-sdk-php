...
use Microsoft\Graph\Generated\Users\Item\ManagedDevices\Item\DeviceCategory\Ref\RefRequestBuilder;
...
class DeviceCategoryRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/users/{user%2Did}/managedDevices/{managedDevice%2Did}/deviceCategory');
    ...
    */
    public function toGetRequestInformation(?DeviceCategoryRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/users/{user%2Did}/managedDevices/{managedDevice%2Did}/deviceCategory{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;

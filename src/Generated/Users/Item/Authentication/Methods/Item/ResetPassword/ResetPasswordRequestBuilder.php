...
class ResetPasswordRequestBuilder 
{
    ...
    */
     ...
     * @param ResetPasswordPostRequestBody $body 
    ...
    */
    public function createPostRequestInformation(ResetPasswordPostRequestBody $body, ?ResetPasswordRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
     ...
     * @return Promise
    */
    public function post(ResetPasswordPostRequestBody $body, ?ResetPasswordRequestBuilderPostRequestConfiguration $requestConfiguration = null, ?ResponseHandler $responseHandler = null): Promise {
        ...
        try {
            ...
            return $this->requestAdapter->sendAsync($requestInfo, array(PasswordResetResponse::class, 'createFromDiscriminatorValue'), $responseHandler, $errorMappings);
        } catch(Exception $ex) {

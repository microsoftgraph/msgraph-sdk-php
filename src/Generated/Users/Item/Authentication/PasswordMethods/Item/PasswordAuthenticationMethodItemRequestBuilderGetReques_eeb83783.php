...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: PasswordAuthenticationMethodItemRequestBuilderGetRequestConfiguration
*/
class PasswordAuthenticationMethodItemRequestBuilderGetReques_eeb83783 extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new PasswordAuthenticationMethodItemRequestBuilderGetReques_eeb83783 and sets the default values.

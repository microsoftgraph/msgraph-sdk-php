...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: PhoneAuthenticationMethodItemRequestBuilderGetRequestConfiguration
*/
class PhoneAuthenticationMethodItemRequestBuilderGetRequestCo_cd07a701 extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new PhoneAuthenticationMethodItemRequestBuilderGetRequestCo_cd07a701 and sets the default values.

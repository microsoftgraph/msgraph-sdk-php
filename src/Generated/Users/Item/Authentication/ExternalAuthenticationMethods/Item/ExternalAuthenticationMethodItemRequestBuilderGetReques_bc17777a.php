...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: ExternalAuthenticationMethodItemRequestBuilderGetRequestConfiguration
*/
class ExternalAuthenticationMethodItemRequestBuilderGetReques_bc17777a extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new ExternalAuthenticationMethodItemRequestBuilderGetReques_bc17777a and sets the default values.

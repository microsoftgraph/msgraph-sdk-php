...
namespace Microsoft\Graph\Generated\Users\Item\CloudClipboard\Items\Count;
...
class CountRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/users/{user%2Did}/cloudClipboard/items/$count{?%24filter,%24search}');

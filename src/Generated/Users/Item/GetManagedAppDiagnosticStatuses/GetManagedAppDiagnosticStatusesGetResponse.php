...
class GetManagedAppDiagnosticStatusesGetResponse extends BaseCollectionPaginationCountResponse implements Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): GetManagedAppDiagnosticStatusesGetResponse {
    ...
    */
    public function getValue(): ?array {
        ...
        if (is_array($val) || is_null($val)) {
            TypeUtils::validateCollectionValues($val, ManagedAppDiagnosticStatus::class);
            /** @var array<ManagedAppDiagnosticStatus>|null $val */
            return $val;
        }

...
*/
class FindMeetingTimesPostRequestBody_minimumAttendeePercentage implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new FindMeetingTimesPostRequestBody_minimumAttendeePercentage and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): FindMeetingTimesPostRequestBody_minimumAttendeePercentage {
        $result = new FindMeetingTimesPostRequestBody_minimumAttendeePercentage();

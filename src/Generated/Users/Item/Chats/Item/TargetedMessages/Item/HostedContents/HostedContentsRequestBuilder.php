...
namespace Microsoft\Graph\Generated\Users\Item\Chats\Item\TargetedMessages\Item\HostedContents;
...
use Microsoft\Graph\Generated\Users\Item\Chats\Item\TargetedMessages\Item\HostedContents\Count\CountRequestBuilder;
use Microsoft\Graph\Generated\Users\Item\Chats\Item\TargetedMessages\Item\HostedContents\Item\ChatMessageHostedContentItemRequestBuilder;
...
class HostedContentsRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function toGetRequestInformation(?HostedContentsRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/users/{user%2Did}/chats/{chat%2Did}/targetedMessages/{targetedChatMessage%2Did}/hostedContents{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}';
    ...
    */
    public function toPostRequestInformation(ChatMessageHostedContent $body, ?HostedContentsRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/users/{user%2Did}/chats/{chat%2Did}/targetedMessages/{targetedChatMessage%2Did}/hostedContents';
        $requestInfo->pathParameters = $this->pathParameters;

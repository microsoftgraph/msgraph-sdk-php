...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: getManagedDevicesWithAppFailuresRequestBuilderGetRequestConfiguration
*/
class GetManagedDevicesWithAppFailuresRequestBuilderGetReques_c4fb74f0 extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new GetManagedDevicesWithAppFailuresRequestBuilderGetReques_c4fb74f0 and sets the default values.

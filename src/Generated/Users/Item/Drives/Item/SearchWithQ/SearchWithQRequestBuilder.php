...
namespace Microsoft\Graph\Generated\Users\Item\Drives\Item\SearchWithQ;
...
class SearchWithQRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $q = null) {
        $this->urlTemplate = '{+baseurl}/users/{user%2Did}/drives/{drive%2Did}/microsoft.graph.search(q=\'{q}\'){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}';

...
class SetCurrentLocationPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new SetCurrentLocationPostRequestBody and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): SetCurrentLocationPostRequestBody {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'updateScope' => fn(ParseNode $n) => $o->setUpdateScope($n->getEnumValue(WorkLocationUpdateScope::class)),
    ...
    */
     ...
     * @return WorkLocationUpdateScope|null
    */
    public function getUpdateScope(): ?WorkLocationUpdateScope {
        $val = $this->getBackingStore()->get('updateScope');
        if (is_null($val) || $val instanceof WorkLocationUpdateScope) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'updateScope'");
    }
    ...
    */
     ...
     * @param WorkLocationUpdateScope|null $value Value to set for the updateScope property.
    */
    public function setUpdateScope(?WorkLocationUpdateScope $value): void {
        $this->getBackingStore()->set('updateScope', $value);
    }

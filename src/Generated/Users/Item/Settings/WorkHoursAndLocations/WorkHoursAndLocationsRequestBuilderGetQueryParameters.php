...
*/
class WorkHoursAndLocationsRequestBuilderGetQueryParameters 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new WorkHoursAndLocationsRequestBuilderGetQueryParameters and sets the default values.

...
class CountRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], "{+baseurl}/users/{user%2Did}/calendars/{calendar%2Did}/events/{event%2Did}/singleValueExtendedProperties/$count{?%24search,%24filter}");

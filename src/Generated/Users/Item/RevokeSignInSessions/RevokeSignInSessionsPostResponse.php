...
class RevokeSignInSessionsPostResponse implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
     ...
     * @return RevokeSignInSessionsPostResponse
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): RevokeSignInSessionsPostResponse {

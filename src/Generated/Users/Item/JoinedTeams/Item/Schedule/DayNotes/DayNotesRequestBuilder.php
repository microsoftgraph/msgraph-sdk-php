...
namespace Microsoft\Graph\Generated\Users\Item\JoinedTeams\Item\Schedule\DayNotes;
...
use Microsoft\Graph\Generated\Users\Item\JoinedTeams\Item\Schedule\DayNotes\Count\CountRequestBuilder;
use Microsoft\Graph\Generated\Users\Item\JoinedTeams\Item\Schedule\DayNotes\Item\DayNoteItemRequestBuilder;
...
class DayNotesRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function toGetRequestInformation(?DayNotesRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/schedule/dayNotes{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}';
    ...
    */
    public function toPostRequestInformation(DayNote $body, ?DayNotesRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/schedule/dayNotes';
        $requestInfo->pathParameters = $this->pathParameters;

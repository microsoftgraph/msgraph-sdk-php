...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: AuthenticationEventsFlowItemRequestBuilderGetRequestConfiguration
*/
class AuthenticationEventsFlowItemRequestBuilderGetRequestCon_9d6a8018 extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new AuthenticationEventsFlowItemRequestBuilderGetRequestCon_9d6a8018 and sets the default values.

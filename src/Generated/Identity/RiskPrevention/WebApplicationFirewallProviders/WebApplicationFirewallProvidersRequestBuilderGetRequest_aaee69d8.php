...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: webApplicationFirewallProvidersRequestBuilderGetRequestConfiguration
*/
class WebApplicationFirewallProvidersRequestBuilderGetRequest_aaee69d8 extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new WebApplicationFirewallProvidersRequestBuilderGetRequest_aaee69d8 and sets the default values.

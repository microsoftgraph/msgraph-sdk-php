...
namespace Microsoft\Graph\Generated\Drive\EscapedList\Items\Item\DocumentSetVersions\Item;

use Exception;
use Http\Promise\Promise;
use Http\Promise\RejectedPromise;
use Microsoft\Graph\Generated\Drive\EscapedList\Items\Item\DocumentSetVersions\Item\Restore\RestoreRequestBuilder;
...
class DocumentSetVersionItemRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/drive/list/items/{listItem%2Did}/documentSetVersions/{documentSetVersion%2Did}{?%24select,%24expand}';

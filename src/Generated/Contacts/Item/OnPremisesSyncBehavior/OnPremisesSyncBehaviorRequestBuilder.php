...
use Microsoft\Graph\Generated\Models\OnPremisesSyncBehavior;
...
class OnPremisesSyncBehaviorRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/contacts/{orgContact%2Did}/onPremisesSyncBehavior');
    ...
    */
    public function toGetRequestInformation(?OnPremisesSyncBehaviorRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/contacts/{orgContact%2Did}/onPremisesSyncBehavior{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;

...
namespace Microsoft\Graph\Generated\Storage\Settings\Quota;

use Exception;
use Http\Promise\Promise;
use Microsoft\Graph\Generated\Models\ODataErrors\ODataError;
use Microsoft\Graph\Generated\Models\UnifiedStorageQuota;
use Microsoft\Graph\Generated\Storage\Settings\Quota\Services\ServicesRequestBuilder;
...
class QuotaRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/storage/settings/quota');
    ...
    */
    public function toGetRequestInformation(?QuotaRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/storage/settings/quota{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;

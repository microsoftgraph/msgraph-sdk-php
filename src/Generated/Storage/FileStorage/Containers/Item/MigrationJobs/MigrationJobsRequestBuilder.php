...
namespace Microsoft\Graph\Generated\Storage\FileStorage\Containers\Item\MigrationJobs;
...
use Microsoft\Graph\Generated\Storage\FileStorage\Containers\Item\MigrationJobs\Count\CountRequestBuilder;
use Microsoft\Graph\Generated\Storage\FileStorage\Containers\Item\MigrationJobs\Item\SharePointMigrationJobItemRequestBuilder;
...
class MigrationJobsRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function toGetRequestInformation(?MigrationJobsRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/migrationJobs{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}';
    ...
    */
    public function toPostRequestInformation(SharePointMigrationJob $body, ?MigrationJobsRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/migrationJobs';
        $requestInfo->pathParameters = $this->pathParameters;

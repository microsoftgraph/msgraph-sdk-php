...
namespace Microsoft\Graph\Generated\Storage\FileStorage\Containers\Item\Drive\Items\Item\Workbook\Functions\Fixed;
...
class FixedPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable 
{
    ...
    */
    public function getNoCommas(): ?Json {
        $val = $this->getBackingStore()->get('noCommas');
        if (is_null($val) || $val instanceof Json) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'noCommas'");
    }

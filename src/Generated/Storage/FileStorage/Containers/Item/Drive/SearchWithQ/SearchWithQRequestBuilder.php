...
namespace Microsoft\Graph\Generated\Storage\FileStorage\Containers\Item\Drive\SearchWithQ;
...
class SearchWithQRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $q = null) {
        parent::__construct($requestAdapter, [], '{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/drive/search(q=\'{q}\'){?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}');

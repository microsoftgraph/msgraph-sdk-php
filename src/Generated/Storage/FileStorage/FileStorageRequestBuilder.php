...
class FileStorageRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function deletedContainers(): DeletedContainersRequestBuilder {
        return new DeletedContainersRequestBuilder($this->pathParameters, $this->requestAdapter);
    }
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/storage/fileStorage');
    ...
    */
    public function toGetRequestInformation(?FileStorageRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/storage/fileStorage{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;

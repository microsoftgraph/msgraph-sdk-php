...
use Microsoft\Graph\Generated\Reports\Partners\Billing\BillingRequestBuilder;
...
class PartnersRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/reports/partners{?%24expand,%24select}');
     ...
     * @param PartnersRequestBuilderDeleteRequestConfiguration|null $requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @return Promise<void|null>
     * @throws Exception
    */
    public function delete(?PartnersRequestBuilderDeleteRequestConfiguration $requestConfiguration = null): Promise {
    ...
    */
    public function get(?PartnersRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
        ...
        return $this->requestAdapter->sendAsync($requestInfo, [Partners::class, 'createFromDiscriminatorValue'], $errorMappings);
    }

    /**
     * Update the navigation property partners in reports
     * @param Partners $body The request body
     * @param PartnersRequestBuilderPatchRequestConfiguration|null $requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @return Promise<Partners|null>
     * @throws Exception
    */
    public function patch(Partners $body, ?PartnersRequestBuilderPatchRequestConfiguration $requestConfiguration = null): Promise {
    ...
    */
    public function toDeleteRequestInformation(?PartnersRequestBuilderDeleteRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/reports/partners';
    ...
    */
     ...
     * @return RequestInformation
    */
    public function toPatchRequestInformation(Partners $body, ?PartnersRequestBuilderPatchRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/reports/partners';
        $requestInfo->pathParameters = $this->pathParameters;

...
use Microsoft\Graph\Generated\Reports\Partners\Billing\Usage\Unbilled\MicrosoftGraphPartnersBillingExport\MicrosoftGraphPartnersBillingExportRequestBuilder;
...
class UnbilledRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/reports/partners/billing/usage/unbilled{?%24expand,%24select}');
    ...
    */
     ...
     * @return Promise<UnbilledUsage|null>
     * @throws Exception
    */
    public function get(?UnbilledRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
        ...
        return $this->requestAdapter->sendAsync($requestInfo, [UnbilledUsage::class, 'createFromDiscriminatorValue'], $errorMappings);
    }

    /**
     * Update the navigation property unbilled in reports
     * @param UnbilledUsage $body The request body
     ...
     * @throws Exception
    */
    public function patch(UnbilledUsage $body, ?UnbilledRequestBuilderPatchRequestConfiguration $requestConfiguration = null): Promise {
    ...
    */
    public function toDeleteRequestInformation(?UnbilledRequestBuilderDeleteRequestConfiguration $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/reports/partners/billing/usage/unbilled';
    ...
    */
     ...
     * @return RequestInformation
    */
    public function toPatchRequestInformation(UnbilledUsage $body, ?UnbilledRequestBuilderPatchRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/reports/partners/billing/usage/unbilled';
        $requestInfo->pathParameters = $this->pathParameters;

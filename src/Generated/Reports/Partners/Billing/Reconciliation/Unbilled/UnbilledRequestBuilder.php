...
class UnbilledRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/reports/partners/billing/reconciliation/unbilled');
    ...
    */
    public function toGetRequestInformation(?UnbilledRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/reports/partners/billing/reconciliation/unbilled{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;

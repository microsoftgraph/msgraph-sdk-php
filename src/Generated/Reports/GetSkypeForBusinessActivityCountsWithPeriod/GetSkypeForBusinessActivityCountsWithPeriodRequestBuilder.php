...
class GetSkypeForBusinessActivityCountsWithPeriodRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
     ...
     * @param GetSkypeForBusinessActivityCountsWithPeriodRequestBuild_f4742c87|null $requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @return Promise<StreamInterface|null>
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/reportroot-getskypeforbusinessactivitycounts?view=graph-rest-1.0 Find more info here
    */
    public function get(?GetSkypeForBusinessActivityCountsWithPeriodRequestBuild_f4742c87 $requestConfiguration = null): Promise {
    ...
    */
    public function toGetRequestInformation(?GetSkypeForBusinessActivityCountsWithPeriodRequestBuild_f4742c87 $requestConfiguration = null): RequestInformation {

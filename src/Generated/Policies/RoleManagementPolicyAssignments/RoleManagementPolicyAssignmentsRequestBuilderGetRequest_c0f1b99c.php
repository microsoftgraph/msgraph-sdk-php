...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: roleManagementPolicyAssignmentsRequestBuilderGetRequestConfiguration
*/
class RoleManagementPolicyAssignmentsRequestBuilderGetRequest_c0f1b99c extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new RoleManagementPolicyAssignmentsRequestBuilderGetRequest_c0f1b99c and sets the default values.
    ...
    */
    public static function createQueryParameters(?bool $count = null, ?array $expand = null, ?string $filter = null, ?array $orderby = null, ?string $search = null, ?array $select = null, ?int $skip = null, ?int $top = null): RoleManagementPolicyAssignmentsRequestBuilderGetQueryParameters {

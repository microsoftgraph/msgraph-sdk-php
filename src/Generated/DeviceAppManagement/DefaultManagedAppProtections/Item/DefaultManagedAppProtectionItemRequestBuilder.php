...
class DefaultManagedAppProtectionItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $defaultManagedAppProtectionId key: id of defaultManagedAppProtection
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $defaultManagedAppProtectionId = null) {
        ...
        $urlTplParams['defaultManagedAppProtectionId'] = $defaultManagedAppProtectionId;

...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: DefaultManagedAppProtectionItemRequestBuilderGetRequestConfiguration
*/
class DefaultManagedAppProtectionItemRequestBuilderGetRequest_4e5a0664 extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new DefaultManagedAppProtectionItemRequestBuilderGetRequest_4e5a0664 and sets the default values.

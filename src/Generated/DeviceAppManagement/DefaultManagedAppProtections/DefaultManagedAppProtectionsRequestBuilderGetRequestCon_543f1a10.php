...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: defaultManagedAppProtectionsRequestBuilderGetRequestConfiguration
*/
class DefaultManagedAppProtectionsRequestBuilderGetRequestCon_543f1a10 extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new DefaultManagedAppProtectionsRequestBuilderGetRequestCon_543f1a10 and sets the default values.
    ...
    */
    public static function createQueryParameters(?bool $count = null, ?array $expand = null, ?string $filter = null, ?array $orderby = null, ?string $search = null, ?array $select = null, ?int $skip = null, ?int $top = null): DefaultManagedAppProtectionsRequestBuilderGetQueryParameters {

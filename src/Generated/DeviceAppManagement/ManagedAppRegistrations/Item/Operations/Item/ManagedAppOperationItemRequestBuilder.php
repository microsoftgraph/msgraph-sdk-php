...
class ManagedAppOperationItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $managedAppOperationId key: id of managedAppOperation
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $managedAppOperationId = null) {
        ...
        $urlTplParams['managedAppOperationId'] = $managedAppOperationId;

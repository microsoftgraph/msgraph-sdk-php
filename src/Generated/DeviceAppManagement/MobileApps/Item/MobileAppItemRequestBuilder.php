...
class MobileAppItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/intune-apps-windowswebapp-delete?view=graph-rest-1.0 Find more info here
    */
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/intune-apps-windowsmicrosoftedgeapp-get?view=graph-rest-1.0 Find more info here
    */
     ...
     * @return Promise<MobileApp|null>
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/intune-apps-managedioslobapp-update?view=graph-rest-1.0 Find more info here
    */

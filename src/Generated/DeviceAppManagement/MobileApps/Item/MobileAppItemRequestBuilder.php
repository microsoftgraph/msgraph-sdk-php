...
class MobileAppItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/intune-apps-macoslobapp-get?view=graph-rest-1.0 Find more info here
    */
     ...
     * @return Promise<MobileApp|null>
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/intune-apps-androidstoreapp-update?view=graph-rest-1.0 Find more info here
    */

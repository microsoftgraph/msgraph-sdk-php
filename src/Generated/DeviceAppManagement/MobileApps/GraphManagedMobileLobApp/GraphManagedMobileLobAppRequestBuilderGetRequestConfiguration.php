...
class GraphManagedMobileLobAppRequestBuilderGetRequestConfiguration 
{
    ...
    */
    public static function addQueryParameters(?bool $count = null, ?array $expand = null, ?string $filter = null, ?array $orderby = null, ?string $search = null, ?array $select = null, ?int $skip = null, ?int $top = null): GraphManagedMobileLobAppRequestBuilderGetQueryParameters {

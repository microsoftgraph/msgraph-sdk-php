...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: targetedManagedAppConfigurationsRequestBuilderGetRequestConfiguration
*/
class TargetedManagedAppConfigurationsRequestBuilderGetReques_0fd6ddec extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new TargetedManagedAppConfigurationsRequestBuilderGetReques_0fd6ddec and sets the default values.
    ...
    */
    public static function createQueryParameters(?bool $count = null, ?array $expand = null, ?string $filter = null, ?array $orderby = null, ?string $search = null, ?array $select = null, ?int $skip = null, ?int $top = null): TargetedManagedAppConfigurationsRequestBuilderGetQueryParameters {

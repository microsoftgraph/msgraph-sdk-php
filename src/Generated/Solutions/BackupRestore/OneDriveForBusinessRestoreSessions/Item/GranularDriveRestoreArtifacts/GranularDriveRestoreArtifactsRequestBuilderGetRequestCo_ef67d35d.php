...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: granularDriveRestoreArtifactsRequestBuilderGetRequestConfiguration
*/
class GranularDriveRestoreArtifactsRequestBuilderGetRequestCo_ef67d35d extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new GranularDriveRestoreArtifactsRequestBuilderGetRequestCo_ef67d35d and sets the default values.

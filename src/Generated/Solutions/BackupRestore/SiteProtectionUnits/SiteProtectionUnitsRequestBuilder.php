...
namespace Microsoft\Graph\Generated\Solutions\BackupRestore\SiteProtectionUnits;
...
use Microsoft\Graph\Generated\Solutions\BackupRestore\SiteProtectionUnits\Count\CountRequestBuilder;
use Microsoft\Graph\Generated\Solutions\BackupRestore\SiteProtectionUnits\Item\SiteProtectionUnitItemRequestBuilder;
...
class SiteProtectionUnitsRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
     ...
     * @param SiteProtectionUnitsRequestBuilderPostRequestConfiguration|null $requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @return Promise<SiteProtectionUnit|null>
     * @throws Exception
    */
    public function post(SiteProtectionUnit $body, ?SiteProtectionUnitsRequestBuilderPostRequestConfiguration $requestConfiguration = null): Promise {
    ...
    */
    public function toGetRequestInformation(?SiteProtectionUnitsRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/solutions/backupRestore/siteProtectionUnits{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}';
     ...
     * @return RequestInformation
    */
    public function toPostRequestInformation(SiteProtectionUnit $body, ?SiteProtectionUnitsRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/solutions/backupRestore/siteProtectionUnits';
        $requestInfo->pathParameters = $this->pathParameters;

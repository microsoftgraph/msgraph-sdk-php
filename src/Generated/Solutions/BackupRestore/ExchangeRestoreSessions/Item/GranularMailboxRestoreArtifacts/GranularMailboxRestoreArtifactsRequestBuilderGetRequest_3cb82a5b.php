...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: granularMailboxRestoreArtifactsRequestBuilderGetRequestConfiguration
*/
class GranularMailboxRestoreArtifactsRequestBuilderGetRequest_3cb82a5b extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new GranularMailboxRestoreArtifactsRequestBuilderGetRequest_3cb82a5b and sets the default values.

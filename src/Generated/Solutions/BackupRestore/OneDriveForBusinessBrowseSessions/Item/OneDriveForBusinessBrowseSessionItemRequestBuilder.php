...
*/
class OneDriveForBusinessBrowseSessionItemRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/solutions/backupRestore/oneDriveForBusinessBrowseSessions/{oneDriveForBusinessBrowseSession%2Did}');
    ...
    */
    public function toGetRequestInformation(?OneDriveForBusinessBrowseSessionItemRequestBuilderGetRe_d3b10beb $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/solutions/backupRestore/oneDriveForBusinessBrowseSessions/{oneDriveForBusinessBrowseSession%2Did}{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
    ...
    */
    public function withUrl(string $rawUrl): OneDriveForBusinessBrowseSessionItemRequestBuilder {
        return new OneDriveForBusinessBrowseSessionItemRequestBuilder($rawUrl, $this->requestAdapter);
    }

...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: sharePointProtectionPoliciesRequestBuilderGetRequestConfiguration
*/
class SharePointProtectionPoliciesRequestBuilderGetRequestCon_9639a61f extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new SharePointProtectionPoliciesRequestBuilderGetRequestCon_9639a61f and sets the default values.

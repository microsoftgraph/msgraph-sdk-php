...
namespace Microsoft\Graph\Generated\Solutions\BackupRestore\ProtectionUnits\GraphSiteProtectionUnit;
...
class GraphSiteProtectionUnitRequestBuilderGetRequestConfiguration extends BaseRequestConfiguration 
{
    ...
    */
    public static function createQueryParameters(?bool $count = null, ?array $expand = null, ?string $filter = null, ?array $orderby = null, ?string $search = null, ?array $select = null, ?int $skip = null, ?int $top = null): GraphSiteProtectionUnitRequestBuilderGetQueryParameters {
        return new GraphSiteProtectionUnitRequestBuilderGetQueryParameters($count, $expand, $filter, $orderby, $search, $select, $skip, $top);
    }

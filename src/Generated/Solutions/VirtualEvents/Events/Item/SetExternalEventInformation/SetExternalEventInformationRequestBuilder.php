...
*/
class SetExternalEventInformationRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/solutions/virtualEvents/events/{virtualEvent%2Did}/setExternalEventInformation');
    ...
    */
    public function withUrl(string $rawUrl): SetExternalEventInformationRequestBuilder {
        return new SetExternalEventInformationRequestBuilder($rawUrl, $this->requestAdapter);
    }

...
class SetExternalEventInformationPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): SetExternalEventInformationPostRequestBody {

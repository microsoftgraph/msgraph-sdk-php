...
class VirtualEventTownhallItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/solutions/virtualEvents/townhalls/{virtualEventTownhall%2Did}');
    ...
    */
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/virtualeventtownhall-get?view=graph-rest-1.0 Find more info here
    */
     ...
     * @return Promise<VirtualEventTownhall|null>
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/virtualeventtownhall-update?view=graph-rest-1.0 Find more info here
    */
    ...
    */
    public function toGetRequestInformation(?VirtualEventTownhallItemRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/solutions/virtualEvents/townhalls/{virtualEventTownhall%2Did}{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;

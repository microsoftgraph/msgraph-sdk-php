...
class SubscriptionsWithCommerceSubscriptionIdRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $commerceSubscriptionId = null) {
        parent::__construct($requestAdapter, [], '{+baseurl}/directory/subscriptions(commerceSubscriptionId=\'{commerceSubscriptionId}\')');
    ...
    */
    public function toGetRequestInformation(?SubscriptionsWithCommerceSubscriptionIdRequestBuilderGe_ec4a3f11 $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/directory/subscriptions(commerceSubscriptionId=\'{commerceSubscriptionId}\'){?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;

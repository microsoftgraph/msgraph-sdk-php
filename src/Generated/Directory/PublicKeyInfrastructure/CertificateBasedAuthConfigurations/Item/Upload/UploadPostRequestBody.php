...
class UploadPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function getFieldDeserializers(): array {
        $o = $this;
        return  [
            'sha256FileHash' => fn(ParseNode $n) => $o->setSha256FileHash($n->getStringValue()),
     ...
     * @return string|null
    */
    public function getSha256FileHash(): ?string {
        $val = $this->getBackingStore()->get('sha256FileHash');
        if (is_null($val) || is_string($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'sha256FileHash'");
    }
    ...
    */
     ...
     * @param string|null $value Value to set for the sha256FileHash property.
    */
    public function setSha256FileHash(?string $value): void {
        $this->getBackingStore()->set('sha256FileHash', $value);
    }

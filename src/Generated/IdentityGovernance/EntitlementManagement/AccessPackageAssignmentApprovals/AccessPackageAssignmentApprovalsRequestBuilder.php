...
class AccessPackageAssignmentApprovalsRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function toGetRequestInformation(?AccessPackageAssignmentApprovalsRequestBuilderGetReques_aed2b56b $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/identityGovernance/entitlementManagement/accessPackageAssignmentApprovals{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}';
    ...
    */
    public function toPostRequestInformation(Approval $body, ?AccessPackageAssignmentApprovalsRequestBuilderPostReque_1600f47e $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/identityGovernance/entitlementManagement/accessPackageAssignmentApprovals';
        $requestInfo->pathParameters = $this->pathParameters;

...
class AssignmentRequestBuilder 
{
    ...
    */
    public function createGetRequestInformation(?AssignmentRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
     ...
     * @return Promise
    */
    public function get(?AssignmentRequestBuilderGetRequestConfiguration $requestConfiguration = null, ?ResponseHandler $responseHandler = null): Promise {

...
use Microsoft\Graph\Generated\IdentityGovernance\EntitlementManagement\AccessPackageSuggestions\Item\AccessPackage\AccessPackageRequestBuilder;
...
*/
class AccessPackageSuggestionItemRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
     ...
     * @param AccessPackageSuggestionItemRequestBuilderGetRequestConfiguration|null $requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @return Promise<AccessPackageSuggestion|null>
     * @throws Exception
    */
    public function get(?AccessPackageSuggestionItemRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
    ...
    */
     ...
     * @return RequestInformation
    */
    public function toGetRequestInformation(?AccessPackageSuggestionItemRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = $this->urlTemplate;
        $requestInfo->pathParameters = $this->pathParameters;
    ...
    */
    public function withUrl(string $rawUrl): AccessPackageSuggestionItemRequestBuilder {
        return new AccessPackageSuggestionItemRequestBuilder($rawUrl, $this->requestAdapter);
    }

...
namespace Microsoft\Graph\Generated\IdentityGovernance\AccessReviews\Unified\Decisions\FilterByCurrentUserWithOn;
...
class FilterByCurrentUserWithOnRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $on = null) {
        parent::__construct($requestAdapter, [], '{+baseurl}/identityGovernance/accessReviews/unified/decisions/filterByCurrentUser(on=\'{on}\'){?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}');

...
class ConnectionOperationItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $connectionOperationId key: id of connectionOperation
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $connectionOperationId = null) {
        ...
        $urlTplParams['connectionOperationId'] = $connectionOperationId;

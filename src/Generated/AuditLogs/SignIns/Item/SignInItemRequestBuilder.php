...
class SignInItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $signInId key: id of signIn
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $signInId = null) {
        $this->urlTemplate = '{+baseurl}/auditLogs/signIns/{signIn%2Did}{?%24select,%24expand}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['signInId'] = $signInId;

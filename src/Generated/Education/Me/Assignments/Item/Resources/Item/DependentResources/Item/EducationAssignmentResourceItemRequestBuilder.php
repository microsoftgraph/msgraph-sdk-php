...
namespace Microsoft\Graph\Generated\Education\Me\Assignments\Item\Resources\Item\DependentResources\Item;
...
class EducationAssignmentResourceItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/education/me/assignments/{educationAssignment%2Did}/resources/{educationAssignmentResource%2Did}/dependentResources/{educationAssignmentResource%2Did1}');
    ...
    */
    public function toGetRequestInformation(?EducationAssignmentResourceItemRequestBuilderGetRequest_a8431760 $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/education/me/assignments/{educationAssignment%2Did}/resources/{educationAssignmentResource%2Did}/dependentResources/{educationAssignmentResource%2Did1}{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;

...
use Microsoft\Graph\Education\Users\Count\CountRequestBuilder;
use Microsoft\Graph\Education\Users\Delta\DeltaRequestBuilder;
use Microsoft\Graph\Models\EducationUser;
use Microsoft\Graph\Models\EducationUserCollectionResponse;
...
class UsersRequestBuilder 
{
    ...
    */
     ...
     * @return RequestInformation
    */
    public function createPostRequestInformation(EducationUser $body, ?UsersRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = $this->urlTemplate;
        $requestInfo->pathParameters = $this->pathParameters;
    ...
    */
     ...
     * @return Promise
    */
    public function post(EducationUser $body, ?UsersRequestBuilderPostRequestConfiguration $requestConfiguration = null, ?ResponseHandler $responseHandler = null): Promise {

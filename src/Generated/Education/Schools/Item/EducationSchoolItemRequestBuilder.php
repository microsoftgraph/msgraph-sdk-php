...
class EducationSchoolItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
     ...
     * @return Promise
     * @link https://docs.microsoft.com/graph/api/educationschool-delete?view=graph-rest-1.0 Find more info here
    */
     ...
     * @return Promise
     * @link https://docs.microsoft.com/graph/api/educationschool-get?view=graph-rest-1.0 Find more info here
    */
     ...
     * @return Promise
     * @link https://docs.microsoft.com/graph/api/educationschool-update?view=graph-rest-1.0 Find more info here
    */

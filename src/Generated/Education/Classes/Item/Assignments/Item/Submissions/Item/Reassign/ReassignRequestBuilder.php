...
class ReassignRequestBuilder 
{
    ...
    */
    public function createPostRequestInformation(?ReassignRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
    ...
    */
    public function post(?ReassignRequestBuilderPostRequestConfiguration $requestConfiguration = null, ?ResponseHandler $responseHandler = null): Promise {
        ...
        try {
            return $this->requestAdapter->sendAsync($requestInfo, array(EducationSubmission::class, 'createFromDiscriminatorValue'), $responseHandler, null);
        } catch(Exception $ex) {

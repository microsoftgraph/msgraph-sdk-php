...
class CountRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/me/contactFolders/{contactFolder%2Did}/contacts/{contact%2Did}/singleValueExtendedProperties/$count{?%24search,%24filter}');

...
namespace Microsoft\Graph\Generated\Me\OwnedObjects\GraphGroup\Count;
...
class CountRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], "{+baseurl}/me/ownedObjects/graph.group/$count{?%24search,%24filter}");

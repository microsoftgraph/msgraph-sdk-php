...
namespace Microsoft\Graph\Generated\Me\TransitiveMemberOf\GraphAdministrativeUnit;

use Exception;
use Http\Promise\Promise;
use Http\Promise\RejectedPromise;
use Microsoft\Graph\Generated\Me\TransitiveMemberOf\GraphAdministrativeUnit\Count\CountRequestBuilder;
...
class GraphAdministrativeUnitRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], "{+baseurl}/me/transitiveMemberOf/graph.administrativeUnit{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}");

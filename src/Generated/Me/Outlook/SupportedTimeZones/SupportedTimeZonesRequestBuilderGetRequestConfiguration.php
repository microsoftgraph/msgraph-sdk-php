...
class SupportedTimeZonesRequestBuilderGetRequestConfiguration 
{
    ...
    */
    public static function addQueryParameters(?bool $count = null, ?string $filter = null, ?string $search = null, ?int $skip = null, ?int $top = null): SupportedTimeZonesRequestBuilderGetQueryParameters {

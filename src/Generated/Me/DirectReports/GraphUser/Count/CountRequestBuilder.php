...
namespace Microsoft\Graph\Generated\Me\DirectReports\GraphUser\Count;
...
class CountRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/me/directReports/graph.user/$count{?%24search,%24filter}');

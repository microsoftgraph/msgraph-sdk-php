...
namespace Microsoft\Graph\Generated\Me\MemberOf\GraphAdministrativeUnit\Count;
...
class CountRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], "{+baseurl}/me/memberOf/graph.administrativeUnit/$count{?%24search,%24filter}");

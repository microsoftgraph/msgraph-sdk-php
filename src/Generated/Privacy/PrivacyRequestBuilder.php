...
class PrivacyRequestBuilder 
{
    ...
    */
    public function createGetRequestInformation(?PrivacyRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
     ...
     * @return RequestInformation
    */
    public function createPatchRequestInformation(Privacy $body, ?PrivacyRequestBuilderPatchRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = $this->urlTemplate;
        $requestInfo->pathParameters = $this->pathParameters;
     ...
     * @return Promise
    */
    public function get(?PrivacyRequestBuilderGetRequestConfiguration $requestConfiguration = null, ?ResponseHandler $responseHandler = null): Promise {
        ...
        try {
            ...
            return $this->requestAdapter->sendAsync($requestInfo, array(Privacy::class, 'createFromDiscriminatorValue'), $responseHandler, $errorMappings);
        } catch(Exception $ex) {
     ...
     * @return Promise
    */
    public function patch(Privacy $body, ?PrivacyRequestBuilderPatchRequestConfiguration $requestConfiguration = null, ?ResponseHandler $responseHandler = null): Promise {

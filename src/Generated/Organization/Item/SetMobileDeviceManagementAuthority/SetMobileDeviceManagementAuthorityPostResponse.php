...
class SetMobileDeviceManagementAuthorityPostResponse implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): SetMobileDeviceManagementAuthorityPostResponse {

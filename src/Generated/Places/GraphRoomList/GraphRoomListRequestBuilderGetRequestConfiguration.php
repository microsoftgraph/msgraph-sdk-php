...
class GraphRoomListRequestBuilderGetRequestConfiguration extends BaseRequestConfiguration 
{
    ...
    */
    public static function createQueryParameters(?bool $count = null, ?array $expand = null, ?string $filter = null, ?array $orderby = null, ?string $search = null, ?array $select = null, ?int $skip = null, ?int $top = null): GraphRoomListRequestBuilderGetQueryParameters {
        return new GraphRoomListRequestBuilderGetQueryParameters($count, $expand, $filter, $orderby, $search, $select, $skip, $top);
    }

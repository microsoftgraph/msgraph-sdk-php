...
use Microsoft\Graph\Generated\Places\Item\GraphRoomList\Rooms\Item\CheckIns\Count\CountRequestBuilder;
use Microsoft\Graph\Generated\Places\Item\GraphRoomList\Rooms\Item\CheckIns\Item\CheckInClaimCalendarEventItemRequestBuilder;
...
class CheckInsRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function toGetRequestInformation(?CheckInsRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/places/{place%2Did}/graph.roomList/rooms/{room%2Did}/checkIns{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}';
    ...
    */
    public function toPostRequestInformation(CheckInClaim $body, ?CheckInsRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/places/{place%2Did}/graph.roomList/rooms/{room%2Did}/checkIns';
        $requestInfo->pathParameters = $this->pathParameters;

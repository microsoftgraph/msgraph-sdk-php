...
namespace Microsoft\Graph\Generated\Places\Item\GraphWorkspace\CheckIns\Item;
...
class CheckInClaimCalendarEventItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/places/{place%2Did}/graph.workspace/checkIns/{checkInClaim%2DcalendarEventId}');
    ...
    */
    public function toGetRequestInformation(?CheckInClaimCalendarEventItemRequestBuilderGetRequestCo_212480ae $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/places/{place%2Did}/graph.workspace/checkIns/{checkInClaim%2DcalendarEventId}{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;

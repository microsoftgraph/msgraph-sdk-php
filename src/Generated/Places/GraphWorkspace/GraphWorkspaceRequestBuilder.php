...
use Microsoft\Graph\Generated\Places\GraphWorkspace\Count\CountRequestBuilder;
...
*/
class GraphWorkspaceRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/places/graph.workspace{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}');
    ...
    */
    public function toGetRequestInformation(?GraphWorkspaceRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
     ...
     * @return GraphWorkspaceRequestBuilder
    */
    public function withUrl(string $rawUrl): GraphWorkspaceRequestBuilder {
        return new GraphWorkspaceRequestBuilder($rawUrl, $this->requestAdapter);
    }

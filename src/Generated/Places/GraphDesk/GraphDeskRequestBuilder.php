...
namespace Microsoft\Graph\Generated\Places\GraphDesk;

use Exception;
use Http\Promise\Promise;
use Microsoft\Graph\Generated\Models\DeskCollectionResponse;
use Microsoft\Graph\Generated\Models\ODataErrors\ODataError;
use Microsoft\Graph\Generated\Places\GraphDesk\Count\CountRequestBuilder;
...
class GraphDeskRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/places/graph.desk{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}');
     ...
     * @return Promise<DeskCollectionResponse|null>
     * @throws Exception
    */
    public function get(?GraphDeskRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
        ...
        return $this->requestAdapter->sendAsync($requestInfo, [DeskCollectionResponse::class, 'createFromDiscriminatorValue'], $errorMappings);
    }

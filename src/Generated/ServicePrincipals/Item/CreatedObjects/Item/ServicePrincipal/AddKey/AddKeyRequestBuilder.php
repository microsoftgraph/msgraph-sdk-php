...
namespace Microsoft\Graph\Generated\ServicePrincipals\Item\CreatedObjects\Item\ServicePrincipal\AddKey;
...
class AddKeyRequestBuilder 
{
    ...
    */
    public function post(KeyCredentialPostRequestBody $body, ?AddKeyRequestBuilderPostRequestConfiguration $requestConfiguration = null, ?ResponseHandler $responseHandler = null): Promise {
        ...
        try {
            return $this->requestAdapter->sendAsync($requestInfo, array(KeyCredential::class, 'createFromDiscriminatorValue'), $responseHandler, null);
        } catch(Exception $ex) {

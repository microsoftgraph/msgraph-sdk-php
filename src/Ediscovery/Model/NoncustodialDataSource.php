...
class NoncustodialDataSource extends DataSourceContainer
{
    ...
    */
    ...
    {
        if (array_key_exists("dataSource", $this->_propDict) && !is_null($this->_propDict["dataSource"])) {
            if (is_a($this->_propDict["dataSource"], "\Microsoft\Graph\Ediscovery\Model\DataSource")) {

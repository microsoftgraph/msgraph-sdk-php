    ...
    */
    public function getAction()
    {
        if (array_key_exists("action", $this->_propDict) && !is_null($this->_propDict["action"])) {
            if (is_a($this->_propDict["action"], "\Microsoft\Graph\Ediscovery\Model\CaseAction")) {
    ...
    */
    public function getStatus()
    {
        if (array_key_exists("status", $this->_propDict) && !is_null($this->_propDict["status"])) {
            if (is_a($this->_propDict["status"], "\Microsoft\Graph\Ediscovery\Model\CaseOperationStatus")) {

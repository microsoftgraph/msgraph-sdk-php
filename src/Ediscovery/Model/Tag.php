    ...
    */
    public function getChildSelectability()
    {
        if (array_key_exists("childSelectability", $this->_propDict)) {
            if (is_a($this->_propDict["childSelectability"], "\Microsoft\Graph\Ediscovery\Model\ChildSelectability") || is_null($this->_propDict["childSelectability"])) {
    ...
    */
    public function getParent()
    {
        if (array_key_exists("parent", $this->_propDict)) {
            if (is_a($this->_propDict["parent"], "\Microsoft\Graph\Ediscovery\Model\Tag") || is_null($this->_propDict["parent"])) {

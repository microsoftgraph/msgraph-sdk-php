    ...
    */
    public function getStatus()
    {
        if (array_key_exists("status", $this->_propDict)) {
            if (is_a($this->_propDict["status"], "\Microsoft\Graph\Ediscovery\Model\DataSourceContainerStatus") || is_null($this->_propDict["status"])) {
    ...
    */
    public function getLastIndexOperation()
    {
        if (array_key_exists("lastIndexOperation", $this->_propDict)) {
            if (is_a($this->_propDict["lastIndexOperation"], "\Microsoft\Graph\Ediscovery\Model\CaseIndexOperation") || is_null($this->_propDict["lastIndexOperation"])) {

...
* @link      https://graph.microsoft.com
*/
class Parameter extends \Microsoft\Graph\Model\Entity
{
    /**
    * Gets the name
    ...
    */
    public function getValueType()
    {
        if (array_key_exists("valueType", $this->_propDict)) {
            if (is_a($this->_propDict["valueType"], "\Microsoft\Graph\IdentityGovernanceNamespace\Model\ValueType") || is_null($this->_propDict["valueType"])) {

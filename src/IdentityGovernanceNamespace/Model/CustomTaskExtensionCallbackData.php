...
* @link      https://graph.microsoft.com
*/
class CustomTaskExtensionCallbackData extends \Microsoft\Graph\Model\CustomExtensionData
{
    ...
    */
    public function getOperationStatus()
    {
        if (array_key_exists("operationStatus", $this->_propDict)) {
            if (is_a($this->_propDict["operationStatus"], "\Microsoft\Graph\IdentityGovernanceNamespace\Model\CustomTaskExtensionOperationStatus") || is_null($this->_propDict["operationStatus"])) {

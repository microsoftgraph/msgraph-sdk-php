...
* @link      https://graph.microsoft.com
*/
class CustomTaskExtension extends \Microsoft\Graph\Model\CustomCalloutExtension
{
    /**
    * Gets the callbackConfiguration
    * The callback configuration for a custom task extension.
    *
    * @return \Microsoft\Graph\Model\CustomExtensionCallbackConfiguration|null The callbackConfiguration
    */
    public function getCallbackConfiguration()
    {
        if (array_key_exists("callbackConfiguration", $this->_propDict)) {
            if (is_a($this->_propDict["callbackConfiguration"], "\Microsoft\Graph\Model\CustomExtensionCallbackConfiguration") || is_null($this->_propDict["callbackConfiguration"])) {
                ...
                $this->_propDict["callbackConfiguration"] = new \Microsoft\Graph\Model\CustomExtensionCallbackConfiguration($this->_propDict["callbackConfiguration"]);
                return $this->_propDict["callbackConfiguration"];
            }
        }
        return null;
    ...
    * The callback configuration for a custom task extension.
    *
    * @param \Microsoft\Graph\Model\CustomExtensionCallbackConfiguration $val The callbackConfiguration
    *
    ...
    *
    * @return \Microsoft\Graph\Model\User|null The createdBy
    */
    public function getCreatedBy()
    {
        if (array_key_exists("createdBy", $this->_propDict)) {
            if (is_a($this->_propDict["createdBy"], "\Microsoft\Graph\Model\User") || is_null($this->_propDict["createdBy"])) {
                return $this->_propDict["createdBy"];
            } else {
                $this->_propDict["createdBy"] = new \Microsoft\Graph\Model\User($this->_propDict["createdBy"]);
                return $this->_propDict["createdBy"];
            }
        }
        return null;
    ...
    * The unique identifier of the Azure AD user that created the custom task extension.Supports $filter(eq, ne) and $expand.
    *
    * @param \Microsoft\Graph\Model\User $val The createdBy
    *
    * @return CustomTaskExtension
    */
    ...
    */
    public function getLastModifiedBy()
    {
        if (array_key_exists("lastModifiedBy", $this->_propDict)) {
            if (is_a($this->_propDict["lastModifiedBy"], "\Microsoft\Graph\Model\User") || is_null($this->_propDict["lastModifiedBy"])) {
                return $this->_propDict["lastModifiedBy"];
            } else {
                $this->_propDict["lastModifiedBy"] = new \Microsoft\Graph\Model\User($this->_propDict["lastModifiedBy"]);
                return $this->_propDict["lastModifiedBy"];
            }
        }
        return null;

...
* @link      https://graph.microsoft.com
*/
class CustomTaskExtensionCalloutData extends \Microsoft\Graph\Model\CustomExtensionData
{
    ...
    * Sets the subject
    *
    * @param \Microsoft\Graph\Model\User $val The value to assign to the subject
    *
    ...
    */
    public function getTaskProcessingresult()
    {
        if (array_key_exists("taskProcessingresult", $this->_propDict)) {
            if (is_a($this->_propDict["taskProcessingresult"], "\Microsoft\Graph\IdentityGovernanceNamespace\Model\TaskProcessingResult") || is_null($this->_propDict["taskProcessingresult"])) {
    ...
    */
    public function getWorkflow()
    {
        if (array_key_exists("workflow", $this->_propDict)) {
            if (is_a($this->_propDict["workflow"], "\Microsoft\Graph\IdentityGovernanceNamespace\Model\Workflow") || is_null($this->_propDict["workflow"])) {

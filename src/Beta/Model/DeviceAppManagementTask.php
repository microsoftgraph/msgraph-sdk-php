    ...
    */
    public function getCategory()
    {
        if (array_key_exists("category", $this->_propDict)) {
            if (is_a($this->_propDict["category"], "Microsoft\Graph\Beta\Model\DeviceAppManagementTaskCategory")) {
    ...
    */
    public function getPriority()
    {
        if (array_key_exists("priority", $this->_propDict)) {
            if (is_a($this->_propDict["priority"], "Microsoft\Graph\Beta\Model\DeviceAppManagementTaskPriority")) {
    ...
    */
    public function getStatus()
    {
        if (array_key_exists("status", $this->_propDict)) {
            if (is_a($this->_propDict["status"], "Microsoft\Graph\Beta\Model\DeviceAppManagementTaskStatus")) {

    ...
    */
    public function getRestartSettings()
    {
        if (array_key_exists("restartSettings", $this->_propDict)) {
            if (is_a($this->_propDict["restartSettings"], "Microsoft\Graph\Beta\Model\Win32LobAppRestartSettings")) {
    ...
    */
    public function getInstallTimeSettings()
    {
        if (array_key_exists("installTimeSettings", $this->_propDict)) {
            if (is_a($this->_propDict["installTimeSettings"], "Microsoft\Graph\Beta\Model\MobileAppInstallTimeSettings")) {

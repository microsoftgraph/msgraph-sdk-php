    ...
    */
    public function getCreatedByIdentity()
    {
        if (array_key_exists("createdByIdentity", $this->_propDict)) {
            if (is_a($this->_propDict["createdByIdentity"], "Microsoft\Graph\Beta\Model\IdentitySet")) {
    ...
    */
    public function getLastModifiedByIdentity()
    {
        if (array_key_exists("lastModifiedByIdentity", $this->_propDict)) {
            if (is_a($this->_propDict["lastModifiedByIdentity"], "Microsoft\Graph\Beta\Model\IdentitySet")) {
    ...
    */
    public function getLastModifiedTime()
    {
        if (array_key_exists("lastModifiedTime", $this->_propDict)) {
            if (is_a($this->_propDict["lastModifiedTime"], "Microsoft\Graph\Beta\Model\\DateTime")) {
    ...
    */
    public function getCreatedTime()
    {
        if (array_key_exists("createdTime", $this->_propDict)) {
            if (is_a($this->_propDict["createdTime"], "Microsoft\Graph\Beta\Model\\DateTime")) {

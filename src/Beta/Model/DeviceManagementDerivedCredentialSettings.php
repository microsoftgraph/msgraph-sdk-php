    ...
    */
    public function getIssuer()
    {
        if (array_key_exists("issuer", $this->_propDict)) {
            if (is_a($this->_propDict["issuer"], "Microsoft\Graph\Beta\Model\DeviceManagementDerivedCredentialIssuer")) {
    ...
    */
    public function getNotificationType()
    {
        if (array_key_exists("notificationType", $this->_propDict)) {
            if (is_a($this->_propDict["notificationType"], "Microsoft\Graph\Beta\Model\DeviceManagementDerivedCredentialNotificationType")) {

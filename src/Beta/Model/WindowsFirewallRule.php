    ...
    */
    public function getProfileTypes()
    {
        if (array_key_exists("profileTypes", $this->_propDict)) {
            if (is_a($this->_propDict["profileTypes"], "Microsoft\Graph\Beta\Model\WindowsFirewallRuleNetworkProfileTypes")) {
    ...
    */
    public function getAction()
    {
        if (array_key_exists("action", $this->_propDict)) {
            if (is_a($this->_propDict["action"], "Microsoft\Graph\Beta\Model\StateManagementSetting")) {
    ...
    */
    public function getTrafficDirection()
    {
        if (array_key_exists("trafficDirection", $this->_propDict)) {
            if (is_a($this->_propDict["trafficDirection"], "Microsoft\Graph\Beta\Model\WindowsFirewallRuleTrafficDirectionType")) {
    ...
    */
    public function getInterfaceTypes()
    {
        if (array_key_exists("interfaceTypes", $this->_propDict)) {
            if (is_a($this->_propDict["interfaceTypes"], "Microsoft\Graph\Beta\Model\WindowsFirewallRuleInterfaceTypes")) {
    ...
    */
    public function getEdgeTraversal()
    {
        if (array_key_exists("edgeTraversal", $this->_propDict)) {
            if (is_a($this->_propDict["edgeTraversal"], "Microsoft\Graph\Beta\Model\StateManagementSetting")) {

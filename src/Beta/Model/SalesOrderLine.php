    ...
    */
    public function getUnitPrice()
    {
        if (array_key_exists("unitPrice", $this->_propDict)) {
            if (is_a($this->_propDict["unitPrice"], "Microsoft\Graph\Beta\Model\Decimal")) {
    ...
    */
    public function getShippedQuantity()
    {
        if (array_key_exists("shippedQuantity", $this->_propDict)) {
            if (is_a($this->_propDict["shippedQuantity"], "Microsoft\Graph\Beta\Model\Decimal")) {
    ...
    */
    public function getInvoicedQuantity()
    {
        if (array_key_exists("invoicedQuantity", $this->_propDict)) {
            if (is_a($this->_propDict["invoicedQuantity"], "Microsoft\Graph\Beta\Model\Decimal")) {
    ...
    */
    public function getInvoiceQuantity()
    {
        if (array_key_exists("invoiceQuantity", $this->_propDict)) {
            if (is_a($this->_propDict["invoiceQuantity"], "Microsoft\Graph\Beta\Model\Decimal")) {
    ...
    */
    public function getShipQuantity()
    {
        if (array_key_exists("shipQuantity", $this->_propDict)) {
            if (is_a($this->_propDict["shipQuantity"], "Microsoft\Graph\Beta\Model\Decimal")) {

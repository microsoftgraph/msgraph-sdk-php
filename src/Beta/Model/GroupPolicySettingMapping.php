    ...
    */
    public function getSettingType()
    {
        if (array_key_exists("settingType", $this->_propDict)) {
            if (is_a($this->_propDict["settingType"], "Microsoft\Graph\Beta\Model\GroupPolicySettingType")) {
    ...
    */
    public function getSettingScope()
    {
        if (array_key_exists("settingScope", $this->_propDict)) {
            if (is_a($this->_propDict["settingScope"], "Microsoft\Graph\Beta\Model\GroupPolicySettingScope")) {

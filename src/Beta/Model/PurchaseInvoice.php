    ...
    */
    public function getBuyFromAddress()
    {
        if (array_key_exists("buyFromAddress", $this->_propDict)) {
            if (is_a($this->_propDict["buyFromAddress"], "Microsoft\Graph\Beta\Model\PostalAddressType")) {
    ...
    */
    public function getPayToAddress()
    {
        if (array_key_exists("payToAddress", $this->_propDict)) {
            if (is_a($this->_propDict["payToAddress"], "Microsoft\Graph\Beta\Model\PostalAddressType")) {
    ...
    */
    public function getShipToAddress()
    {
        if (array_key_exists("shipToAddress", $this->_propDict)) {
            if (is_a($this->_propDict["shipToAddress"], "Microsoft\Graph\Beta\Model\PostalAddressType")) {
    ...
    */
    public function getVendor()
    {
        if (array_key_exists("vendor", $this->_propDict)) {
            if (is_a($this->_propDict["vendor"], "Microsoft\Graph\Beta\Model\Vendor")) {

    ...
    */
    public function getOwnerType()
    {
        if (array_key_exists("ownerType", $this->_propDict)) {
            if (is_a($this->_propDict["ownerType"], "Microsoft\Graph\Beta\Model\ManagedDeviceOwnerType")) {
    ...
    */
    public function getEnrollmentType()
    {
        if (array_key_exists("enrollmentType", $this->_propDict)) {
            if (is_a($this->_propDict["enrollmentType"], "Microsoft\Graph\Beta\Model\AppleUserInitiatedEnrollmentType")) {

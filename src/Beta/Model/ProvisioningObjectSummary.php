...
class ProvisioningObjectSummary extends Entity
{
    ...
    * Gets the initatedBy
    *
    * @return Initiator The initatedBy
    */
    public function getInitatedBy()
    {
        if (array_key_exists("initatedBy", $this->_propDict)) {
            if (is_a($this->_propDict["initatedBy"], "Microsoft\Graph\Beta\Model\Initiator")) {
                return $this->_propDict["initatedBy"];
            } else {
                $this->_propDict["initatedBy"] = new Initiator($this->_propDict["initatedBy"]);
                return $this->_propDict["initatedBy"];
            }
        }
        return null;
    ...
    * Sets the initatedBy
    *
    * @param Initiator $val The initatedBy
    *
    * @return ProvisioningObjectSummary
    */
    public function setInitatedBy($val)
    {
        $this->_propDict["initatedBy"] = $val;
        return $this;
    }

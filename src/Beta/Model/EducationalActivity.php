    ...
    */
    public function getInstitution()
    {
        if (array_key_exists("institution", $this->_propDict)) {
            if (is_a($this->_propDict["institution"], "Microsoft\Graph\Beta\Model\InstitutionData")) {
    ...
    */
    public function getProgram()
    {
        if (array_key_exists("program", $this->_propDict)) {
            if (is_a($this->_propDict["program"], "Microsoft\Graph\Beta\Model\EducationalActivityDetail")) {

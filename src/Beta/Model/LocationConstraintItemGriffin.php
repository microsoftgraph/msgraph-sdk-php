...
* 
* LocationConstraintItemGriffin File
* PHP version 7
*
* @category  Library
...
/**
* LocationConstraintItemGriffin class
*
* @category  Model
* @package   Microsoft.Graph
* @copyright © Microsoft Corporation. All rights reserved.
...
* @link      https://graph.microsoft.io/
*/
class LocationConstraintItemGriffin extends LocationDataModel
{
    /**
    ...
    *
    * @return LocationConstraintItemGriffin
    */

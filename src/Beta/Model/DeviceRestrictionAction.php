    ...
    */
    public function getRestrictionAction()
    {
        if (array_key_exists("restrictionAction", $this->_propDict)) {
            if (is_a($this->_propDict["restrictionAction"], "Microsoft\Graph\Beta\Model\RestrictionAction")) {
    ...
    */
    public function getTriggers()
    {
        if (array_key_exists("triggers", $this->_propDict)) {
            if (is_a($this->_propDict["triggers"], "Microsoft\Graph\Beta\Model\RestrictionTrigger")) {

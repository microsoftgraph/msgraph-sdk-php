    ...
    */
    public function getBandwidthBackgroundPercentageHours()
    {
        if (array_key_exists("bandwidthBackgroundPercentageHours", $this->_propDict)) {
            if (is_a($this->_propDict["bandwidthBackgroundPercentageHours"], "Microsoft\Graph\Beta\Model\DeliveryOptimizationBandwidthBusinessHoursLimit")) {
    ...
    */
    public function getBandwidthForegroundPercentageHours()
    {
        if (array_key_exists("bandwidthForegroundPercentageHours", $this->_propDict)) {
            if (is_a($this->_propDict["bandwidthForegroundPercentageHours"], "Microsoft\Graph\Beta\Model\DeliveryOptimizationBandwidthBusinessHoursLimit")) {

    ...
    */
    public function getOrganized()
    {
        if (array_key_exists("organized", $this->_propDict)) {
            if (is_a($this->_propDict["organized"], "Microsoft\Graph\Beta\Model\Duration")) {
    ...
    */
    public function getRecurring()
    {
        if (array_key_exists("recurring", $this->_propDict)) {
            if (is_a($this->_propDict["recurring"], "Microsoft\Graph\Beta\Model\Duration")) {
    ...
    */
    public function getLong()
    {
        if (array_key_exists("long", $this->_propDict)) {
            if (is_a($this->_propDict["long"], "Microsoft\Graph\Beta\Model\Duration")) {
    ...
    */
    public function getConflicting()
    {
        if (array_key_exists("conflicting", $this->_propDict)) {
            if (is_a($this->_propDict["conflicting"], "Microsoft\Graph\Beta\Model\Duration")) {
    ...
    */
    public function getMultitasking()
    {
        if (array_key_exists("multitasking", $this->_propDict)) {
            if (is_a($this->_propDict["multitasking"], "Microsoft\Graph\Beta\Model\Duration")) {

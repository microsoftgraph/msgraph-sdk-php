    ...
    */
    public function getDefaultEnrollmentType()
    {
        if (array_key_exists("defaultEnrollmentType", $this->_propDict)) {
            if (is_a($this->_propDict["defaultEnrollmentType"], "Microsoft\Graph\Beta\Model\AppleUserInitiatedEnrollmentType")) {
    ...
    */
    public function getPlatform()
    {
        if (array_key_exists("platform", $this->_propDict)) {
            if (is_a($this->_propDict["platform"], "Microsoft\Graph\Beta\Model\DevicePlatformType")) {

    ...
    */
    public function getAutomatic()
    {
        if (array_key_exists("automatic", $this->_propDict)) {
            if (is_a($this->_propDict["automatic"], "Microsoft\Graph\Beta\Model\EvaluateLabelJobResult")) {
    ...
    */
    public function getRecommended()
    {
        if (array_key_exists("recommended", $this->_propDict)) {
            if (is_a($this->_propDict["recommended"], "Microsoft\Graph\Beta\Model\EvaluateLabelJobResult")) {

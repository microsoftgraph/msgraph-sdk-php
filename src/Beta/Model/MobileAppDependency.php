...
class MobileAppDependency extends MobileAppRelationship
{
    ...
    *
    * @return MobileAppDependecyType The dependencyType
    */
    public function getDependencyType()
    {
        if (array_key_exists("dependencyType", $this->_propDict)) {
            if (is_a($this->_propDict["dependencyType"], "Microsoft\Graph\Beta\Model\MobileAppDependecyType")) {
                return $this->_propDict["dependencyType"];
            } else {
                $this->_propDict["dependencyType"] = new MobileAppDependecyType($this->_propDict["dependencyType"]);
                return $this->_propDict["dependencyType"];
            }
        }
        return null;
    ...
    * The type of dependency relationship between the parent and child apps.
    *
    * @param MobileAppDependecyType $val The dependencyType
    *

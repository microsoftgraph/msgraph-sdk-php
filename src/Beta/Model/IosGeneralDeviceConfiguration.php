...
class IosGeneralDeviceConfiguration extends DeviceConfiguration
{
    ...
    */
    ...
    /**
    * Gets the wiFiBlockPowerModification
    * Indicates whether or not to block WiFi power modification when the device is supervised (iOS 13 or later).
    *
    * @return bool The wiFiBlockPowerModification
    */
    public function getWiFiBlockPowerModification()
    {
        if (array_key_exists("wiFiBlockPowerModification", $this->_propDict)) {
            return $this->_propDict["wiFiBlockPowerModification"];
        } else {
            return null;
        }
    }
    ...
    /**
    * Sets the wiFiBlockPowerModification
    * Indicates whether or not to block WiFi power modification when the device is supervised (iOS 13 or later).
    *
    * @param bool $val The wiFiBlockPowerModification
    *
    * @return IosGeneralDeviceConfiguration
    */
    public function setWiFiBlockPowerModification($val)
    {
        $this->_propDict["wiFiBlockPowerModification"] = boolval($val);
        return $this;
    }

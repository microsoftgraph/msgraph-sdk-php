    ...
    */
    public function getDecisionMakerCriteria()
    {
        if (array_key_exists("decisionMakerCriteria", $this->_propDict)) {
            if (is_a($this->_propDict["decisionMakerCriteria"], "Microsoft\Graph\Beta\Model\GovernanceCriteria")) {
    ...
    */
    public function getNotificationPolicy()
    {
        if (array_key_exists("notificationPolicy", $this->_propDict)) {
            if (is_a($this->_propDict["notificationPolicy"], "Microsoft\Graph\Beta\Model\GovernanceNotificationPolicy")) {

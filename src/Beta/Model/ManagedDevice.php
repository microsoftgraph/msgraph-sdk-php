...
class ManagedDevice extends Entity
{
    ...
    */
    ...
    /**
    * Gets the lastLoggedOnUserId
    *
    * @return string The lastLoggedOnUserId
    */
    public function getLastLoggedOnUserId()
    {
        if (array_key_exists("lastLoggedOnUserId", $this->_propDict)) {
            return $this->_propDict["lastLoggedOnUserId"];
        } else {
            return null;
        }
    }
    ...
    /**
    * Sets the lastLoggedOnUserId
    *
    * @param string $val The lastLoggedOnUserId
    *
    * @return ManagedDevice
    */
    public function setLastLoggedOnUserId($val)
    {
        $this->_propDict["lastLoggedOnUserId"] = $val;
        return $this;
    }

...
class Customer extends Entity
{
    ...
    */
    public function getAddress()
    {
        if (array_key_exists("address", $this->_propDict)) {
            if (is_a($this->_propDict["address"], "Microsoft\Graph\Beta\Model\PostalAddressType")) {
    ...
    */
    public function getBalance()
    {
        if (array_key_exists("balance", $this->_propDict)) {
            if (is_a($this->_propDict["balance"], "Microsoft\Graph\Beta\Model\Decimal")) {
    ...
    */
    ...
    /**
    * Gets the overdueAmount
    *
    * @return Decimal The overdueAmount
    */
    public function getOverdueAmount()
    {
        if (array_key_exists("overdueAmount", $this->_propDict)) {
            if (is_a($this->_propDict["overdueAmount"], "Microsoft\Graph\Beta\Model\Decimal")) {
                return $this->_propDict["overdueAmount"];
            } else {
                $this->_propDict["overdueAmount"] = new Decimal($this->_propDict["overdueAmount"]);
                return $this->_propDict["overdueAmount"];
            }
        }
        return null;
    ...
    *
    * @param Decimal $val The overdueAmount
    *
    * @return Customer
    */
    public function setOverdueAmount($val)
    {
        $this->_propDict["overdueAmount"] = $val;
        return $this;
    }
    
    /**
    * Gets the totalSalesExcludingTax
    *
    * @return Decimal The totalSalesExcludingTax
    */
    public function getTotalSalesExcludingTax()
    {
        if (array_key_exists("totalSalesExcludingTax", $this->_propDict)) {
            if (is_a($this->_propDict["totalSalesExcludingTax"], "Microsoft\Graph\Beta\Model\Decimal")) {
                return $this->_propDict["totalSalesExcludingTax"];
            } else {
                $this->_propDict["totalSalesExcludingTax"] = new Decimal($this->_propDict["totalSalesExcludingTax"]);
                return $this->_propDict["totalSalesExcludingTax"];
            }
        }
        return null;
    ...
    /**
    * Sets the totalSalesExcludingTax
    *
    * @param Decimal $val The totalSalesExcludingTax
    *
    * @return Customer
    */
    public function setTotalSalesExcludingTax($val)
    {
        $this->_propDict["totalSalesExcludingTax"] = $val;
        return $this;
    }
    ...
    */
    public function getCurrency()
    {
        if (array_key_exists("currency", $this->_propDict)) {
            if (is_a($this->_propDict["currency"], "Microsoft\Graph\Beta\Model\Currency")) {
    ...
    */
    public function getPaymentTerm()
    {
        if (array_key_exists("paymentTerm", $this->_propDict)) {
            if (is_a($this->_propDict["paymentTerm"], "Microsoft\Graph\Beta\Model\PaymentTerm")) {
    ...
    */
    public function getShipmentMethod()
    {
        if (array_key_exists("shipmentMethod", $this->_propDict)) {
            if (is_a($this->_propDict["shipmentMethod"], "Microsoft\Graph\Beta\Model\ShipmentMethod")) {
    ...
    */
    public function getPaymentMethod()
    {
        if (array_key_exists("paymentMethod", $this->_propDict)) {
            if (is_a($this->_propDict["paymentMethod"], "Microsoft\Graph\Beta\Model\PaymentMethod")) {

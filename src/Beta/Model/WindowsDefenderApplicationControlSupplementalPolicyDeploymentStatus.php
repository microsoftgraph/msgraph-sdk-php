    ...
    */
    public function getDeploymentStatus()
    {
        if (array_key_exists("deploymentStatus", $this->_propDict)) {
            if (is_a($this->_propDict["deploymentStatus"], "Microsoft\Graph\Beta\Model\WindowsDefenderApplicationControlSupplementalPolicyStatuses")) {
    ...
    */
    public function getPolicy()
    {
        if (array_key_exists("policy", $this->_propDict)) {
            if (is_a($this->_propDict["policy"], "Microsoft\Graph\Beta\Model\WindowsDefenderApplicationControlSupplementalPolicy")) {

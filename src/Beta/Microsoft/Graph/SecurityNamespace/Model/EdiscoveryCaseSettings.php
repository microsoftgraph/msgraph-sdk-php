    ...
    */
    public function getOcr()
    {
        if (array_key_exists("ocr", $this->_propDict)) {
            if (is_a($this->_propDict["ocr"], "\Beta\Microsoft\Graph\Security\Model\OcrSettings") || is_null($this->_propDict["ocr"])) {
    ...
    */
    public function getRedundancyDetection()
    {
        if (array_key_exists("redundancyDetection", $this->_propDict)) {
            if (is_a($this->_propDict["redundancyDetection"], "\Beta\Microsoft\Graph\Security\Model\RedundancyDetectionSettings") || is_null($this->_propDict["redundancyDetection"])) {
    ...
    */
    public function getTopicModeling()
    {
        if (array_key_exists("topicModeling", $this->_propDict)) {
            if (is_a($this->_propDict["topicModeling"], "\Beta\Microsoft\Graph\Security\Model\TopicModelingSettings") || is_null($this->_propDict["topicModeling"])) {

    ...
    */
    public function getReviewSet()
    {
        if (array_key_exists("reviewSet", $this->_propDict)) {
            if (is_a($this->_propDict["reviewSet"], "\Beta\Microsoft\Graph\Security\Model\EdiscoveryReviewSet") || is_null($this->_propDict["reviewSet"])) {
    ...
    */
    public function getSearch()
    {
        if (array_key_exists("search", $this->_propDict)) {
            if (is_a($this->_propDict["search"], "\Beta\Microsoft\Graph\Security\Model\EdiscoverySearch") || is_null($this->_propDict["search"])) {

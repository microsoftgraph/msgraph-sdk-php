...
* @link      https://graph.microsoft.com
*/
class KubernetesServicePort extends \Beta\Microsoft\Graph\Model\Entity
{
    /**
    ...
    */
    public function getProtocol()
    {
        if (array_key_exists("protocol", $this->_propDict)) {
            if (is_a($this->_propDict["protocol"], "\Beta\Microsoft\Graph\SecurityNamespace\Model\ContainerPortProtocol") || is_null($this->_propDict["protocol"])) {

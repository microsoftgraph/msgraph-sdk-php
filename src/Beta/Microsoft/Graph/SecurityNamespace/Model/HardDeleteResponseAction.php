...
/**
* HardDeleteResponseAction class
*
* @category  Model
* @package   Microsoft.Graph
* @copyright (c) Microsoft Corporation. All rights reserved.
...
* @link      https://graph.microsoft.com
*/
class HardDeleteResponseAction extends ResponseAction
{
    ...
    *
    * @return HardDeleteResponseAction The HardDeleteResponseAction
    */

    ...
    */
    public function getDataSourceScopes()
    {
        if (array_key_exists("dataSourceScopes", $this->_propDict)) {
            if (is_a($this->_propDict["dataSourceScopes"], "\Beta\Microsoft\Graph\Security\Model\DataSourceScopes") || is_null($this->_propDict["dataSourceScopes"])) {
    ...
    */
    public function getAddToReviewSetOperation()
    {
        if (array_key_exists("addToReviewSetOperation", $this->_propDict)) {
            if (is_a($this->_propDict["addToReviewSetOperation"], "\Beta\Microsoft\Graph\Security\Model\EdiscoveryAddToReviewSetOperation") || is_null($this->_propDict["addToReviewSetOperation"])) {
    ...
    */
    public function getLastEstimateStatisticsOperation()
    {
        if (array_key_exists("lastEstimateStatisticsOperation", $this->_propDict)) {
            if (is_a($this->_propDict["lastEstimateStatisticsOperation"], "\Beta\Microsoft\Graph\Security\Model\EdiscoveryEstimateOperation") || is_null($this->_propDict["lastEstimateStatisticsOperation"])) {

    ...
    */
    public function getChildSelectability()
    {
        if (array_key_exists("childSelectability", $this->_propDict)) {
            if (is_a($this->_propDict["childSelectability"], "\Beta\Microsoft\Graph\Security\Model\ChildSelectability") || is_null($this->_propDict["childSelectability"])) {
    ...
    */
    public function getParent()
    {
        if (array_key_exists("parent", $this->_propDict)) {
            if (is_a($this->_propDict["parent"], "\Beta\Microsoft\Graph\Security\Model\EdiscoveryReviewTag") || is_null($this->_propDict["parent"])) {

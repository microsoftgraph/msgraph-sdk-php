    ...
    */
    public function getHoldStatus()
    {
        if (array_key_exists("holdStatus", $this->_propDict)) {
            if (is_a($this->_propDict["holdStatus"], "\Beta\Microsoft\Graph\Security\Model\DataSourceHoldStatus") || is_null($this->_propDict["holdStatus"])) {
    ...
    */
    public function getStatus()
    {
        if (array_key_exists("status", $this->_propDict)) {
            if (is_a($this->_propDict["status"], "\Beta\Microsoft\Graph\Security\Model\DataSourceContainerStatus") || is_null($this->_propDict["status"])) {

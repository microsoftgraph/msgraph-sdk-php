...
* 
* MoveToDeletedItemsResponseAction File
* PHP version 7
*
* @category  Library
...
/**
* MoveToDeletedItemsResponseAction class
*
* @category  Model
* @package   Microsoft.Graph
* @copyright (c) Microsoft Corporation. All rights reserved.
...
* @link      https://graph.microsoft.com
*/
class MoveToDeletedItemsResponseAction extends ResponseAction
{
    ...
    *
    * @return MoveToDeletedItemsResponseAction The MoveToDeletedItemsResponseAction
    */

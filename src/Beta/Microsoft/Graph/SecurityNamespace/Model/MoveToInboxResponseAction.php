...
* 
* MoveToInboxResponseAction File
* PHP version 7
*
* @category  Library
...
/**
* MoveToInboxResponseAction class
*
* @category  Model
* @package   Microsoft.Graph
* @copyright (c) Microsoft Corporation. All rights reserved.
...
* @link      https://graph.microsoft.com
*/
class MoveToInboxResponseAction extends ResponseAction
{
    ...
    *
    * @return MoveToInboxResponseAction The MoveToInboxResponseAction
    */

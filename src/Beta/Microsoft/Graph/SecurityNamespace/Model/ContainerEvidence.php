    ...
    */
    public function getImage()
    {
        if (array_key_exists("image", $this->_propDict)) {
            if (is_a($this->_propDict["image"], "\Beta\Microsoft\Graph\SecurityNamespace\Model\ContainerImageEvidence") || is_null($this->_propDict["image"])) {
    ...
    */
    public function getPod()
    {
        if (array_key_exists("pod", $this->_propDict)) {
            if (is_a($this->_propDict["pod"], "\Beta\Microsoft\Graph\SecurityNamespace\Model\KubernetesPodEvidence") || is_null($this->_propDict["pod"])) {

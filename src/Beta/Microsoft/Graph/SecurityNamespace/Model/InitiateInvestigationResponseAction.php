...
* 
* InitiateInvestigationResponseAction File
* PHP version 7
*
* @category  Library
...
/**
* InitiateInvestigationResponseAction class
*
* @category  Model
* @package   Microsoft.Graph
* @copyright (c) Microsoft Corporation. All rights reserved.
...
* @link      https://graph.microsoft.com
*/
class InitiateInvestigationResponseAction extends ResponseAction
{
    ...
    *
    * @return InitiateInvestigationResponseAction The InitiateInvestigationResponseAction
    */

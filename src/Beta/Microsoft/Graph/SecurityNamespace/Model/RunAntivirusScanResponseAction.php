...
* 
* RunAntivirusScanResponseAction File
* PHP version 7
*
* @category  Library
...
/**
* RunAntivirusScanResponseAction class
*
* @category  Model
* @package   Microsoft.Graph
* @copyright (c) Microsoft Corporation. All rights reserved.
...
* @link      https://graph.microsoft.com
*/
class RunAntivirusScanResponseAction extends ResponseAction
{
    ...
    *
    * @return RunAntivirusScanResponseAction The RunAntivirusScanResponseAction
    */

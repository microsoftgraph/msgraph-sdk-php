    ...
    */
    public function getExportOptions()
    {
        if (array_key_exists("exportOptions", $this->_propDict)) {
            if (is_a($this->_propDict["exportOptions"], "\Beta\Microsoft\Graph\Security\Model\ExportOptions") || is_null($this->_propDict["exportOptions"])) {
    ...
    */
    public function getExportStructure()
    {
        if (array_key_exists("exportStructure", $this->_propDict)) {
            if (is_a($this->_propDict["exportStructure"], "\Beta\Microsoft\Graph\Security\Model\ExportFileStructure") || is_null($this->_propDict["exportStructure"])) {
    ...
    */
    public function getReviewSetQuery()
    {
        if (array_key_exists("reviewSetQuery", $this->_propDict)) {
            if (is_a($this->_propDict["reviewSetQuery"], "\Beta\Microsoft\Graph\Security\Model\EdiscoveryReviewSetQuery") || is_null($this->_propDict["reviewSetQuery"])) {

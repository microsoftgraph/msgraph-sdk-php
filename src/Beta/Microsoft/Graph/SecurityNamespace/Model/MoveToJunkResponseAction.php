...
/**
* MoveToJunkResponseAction class
*
* @category  Model
* @package   Microsoft.Graph
* @copyright (c) Microsoft Corporation. All rights reserved.
...
* @link      https://graph.microsoft.com
*/
class MoveToJunkResponseAction extends ResponseAction
{
    ...
    *
    * @return MoveToJunkResponseAction The MoveToJunkResponseAction
    */

    ...
    */
    public function getOtherProperties()
    {
        if (array_key_exists("otherProperties", $this->_propDict)) {
            if (is_a($this->_propDict["otherProperties"], "\Beta\Microsoft\Graph\Security\Model\StringValueDictionary") || is_null($this->_propDict["otherProperties"])) {
    ...
    */
    public function getProcessingStatus()
    {
        if (array_key_exists("processingStatus", $this->_propDict)) {
            if (is_a($this->_propDict["processingStatus"], "\Beta\Microsoft\Graph\Security\Model\FileProcessingStatus") || is_null($this->_propDict["processingStatus"])) {
    ...
    */
    public function getSourceType()
    {
        if (array_key_exists("sourceType", $this->_propDict)) {
            if (is_a($this->_propDict["sourceType"], "\Beta\Microsoft\Graph\Security\Model\SourceType") || is_null($this->_propDict["sourceType"])) {

...
class Office365ActiveUserDetail extends Entity
{
    ...
    *
    * @return \Microsoft\Graph\Core\Models\Date|null The exchangeLastActivityDate
    */
    public function getExchangeLastActivityDate()
    {
        if (array_key_exists("exchangeLastActivityDate", $this->_propDict)) {
            if (is_a($this->_propDict["exchangeLastActivityDate"], "\Microsoft\Graph\Core\Models\Date") || is_null($this->_propDict["exchangeLastActivityDate"])) {
                return $this->_propDict["exchangeLastActivityDate"];
            } else {
                $this->_propDict["exchangeLastActivityDate"] = new \Microsoft\Graph\Core\Models\Date($this->_propDict["exchangeLastActivityDate"]);
                return $this->_propDict["exchangeLastActivityDate"];
            }
        }
        return null;
    ...
    * The date when user last read or sent email.
    *
    * @param \Microsoft\Graph\Core\Models\Date $val The exchangeLastActivityDate
    *
    * @return Office365ActiveUserDetail
    */
    ...
    *
    * @return \Microsoft\Graph\Core\Models\Date|null The exchangeLicenseAssignDate
    */
    public function getExchangeLicenseAssignDate()
    {
        if (array_key_exists("exchangeLicenseAssignDate", $this->_propDict)) {
            if (is_a($this->_propDict["exchangeLicenseAssignDate"], "\Microsoft\Graph\Core\Models\Date") || is_null($this->_propDict["exchangeLicenseAssignDate"])) {
                return $this->_propDict["exchangeLicenseAssignDate"];
            } else {
                $this->_propDict["exchangeLicenseAssignDate"] = new \Microsoft\Graph\Core\Models\Date($this->_propDict["exchangeLicenseAssignDate"]);
                return $this->_propDict["exchangeLicenseAssignDate"];
            }
        }
        return null;
    ...
    * The last date when the user was assigned an Exchange license.
    *
    * @param \Microsoft\Graph\Core\Models\Date $val The exchangeLicenseAssignDate
    *
    * @return Office365ActiveUserDetail
    */
    ...
    *
    * @return \Microsoft\Graph\Core\Models\Date|null The oneDriveLastActivityDate
    */
    public function getOneDriveLastActivityDate()
    {
        if (array_key_exists("oneDriveLastActivityDate", $this->_propDict)) {
            if (is_a($this->_propDict["oneDriveLastActivityDate"], "\Microsoft\Graph\Core\Models\Date") || is_null($this->_propDict["oneDriveLastActivityDate"])) {
                return $this->_propDict["oneDriveLastActivityDate"];
            } else {
                $this->_propDict["oneDriveLastActivityDate"] = new \Microsoft\Graph\Core\Models\Date($this->_propDict["oneDriveLastActivityDate"]);
                return $this->_propDict["oneDriveLastActivityDate"];
            }
        }
        return null;
    ...
    * The date when user last viewed or edited files, shared files internally or externally, or synced files.
    *
    * @param \Microsoft\Graph\Core\Models\Date $val The oneDriveLastActivityDate
    *
    * @return Office365ActiveUserDetail
    */
    ...
    *
    * @return \Microsoft\Graph\Core\Models\Date|null The oneDriveLicenseAssignDate
    */
    public function getOneDriveLicenseAssignDate()
    {
        if (array_key_exists("oneDriveLicenseAssignDate", $this->_propDict)) {
            if (is_a($this->_propDict["oneDriveLicenseAssignDate"], "\Microsoft\Graph\Core\Models\Date") || is_null($this->_propDict["oneDriveLicenseAssignDate"])) {
                return $this->_propDict["oneDriveLicenseAssignDate"];
            } else {
                $this->_propDict["oneDriveLicenseAssignDate"] = new \Microsoft\Graph\Core\Models\Date($this->_propDict["oneDriveLicenseAssignDate"]);
                return $this->_propDict["oneDriveLicenseAssignDate"];
            }
        }
        return null;
    ...
    * The last date when the user was assigned a OneDrive license.
    *
    * @param \Microsoft\Graph\Core\Models\Date $val The oneDriveLicenseAssignDate
    *
    * @return Office365ActiveUserDetail
    */
    ...
    *
    * @return \Microsoft\Graph\Core\Models\Date|null The sharePointLastActivityDate
    */
    public function getSharePointLastActivityDate()
    {
        if (array_key_exists("sharePointLastActivityDate", $this->_propDict)) {
            if (is_a($this->_propDict["sharePointLastActivityDate"], "\Microsoft\Graph\Core\Models\Date") || is_null($this->_propDict["sharePointLastActivityDate"])) {
                return $this->_propDict["sharePointLastActivityDate"];
            } else {
                $this->_propDict["sharePointLastActivityDate"] = new \Microsoft\Graph\Core\Models\Date($this->_propDict["sharePointLastActivityDate"]);
                return $this->_propDict["sharePointLastActivityDate"];
            }
        }
        return null;
    ...
    * The date when user last viewed or edited files, shared files internally or externally, synced files, or viewed SharePoint pages.
    *
    * @param \Microsoft\Graph\Core\Models\Date $val The sharePointLastActivityDate
    *
    * @return Office365ActiveUserDetail
    */
    ...
    *
    * @return \Microsoft\Graph\Core\Models\Date|null The sharePointLicenseAssignDate
    */
    public function getSharePointLicenseAssignDate()
    {
        if (array_key_exists("sharePointLicenseAssignDate", $this->_propDict)) {
            if (is_a($this->_propDict["sharePointLicenseAssignDate"], "\Microsoft\Graph\Core\Models\Date") || is_null($this->_propDict["sharePointLicenseAssignDate"])) {
                return $this->_propDict["sharePointLicenseAssignDate"];
            } else {
                $this->_propDict["sharePointLicenseAssignDate"] = new \Microsoft\Graph\Core\Models\Date($this->_propDict["sharePointLicenseAssignDate"]);
                return $this->_propDict["sharePointLicenseAssignDate"];
            }
        }
        return null;
    ...
    * The last date when the user was assigned a SharePoint license.
    *
    * @param \Microsoft\Graph\Core\Models\Date $val The sharePointLicenseAssignDate
    *
    * @return Office365ActiveUserDetail
    */
    ...
    *
    * @return \Microsoft\Graph\Core\Models\Date|null The skypeForBusinessLastActivityDate
    */
    public function getSkypeForBusinessLastActivityDate()
    {
        if (array_key_exists("skypeForBusinessLastActivityDate", $this->_propDict)) {
            if (is_a($this->_propDict["skypeForBusinessLastActivityDate"], "\Microsoft\Graph\Core\Models\Date") || is_null($this->_propDict["skypeForBusinessLastActivityDate"])) {
                return $this->_propDict["skypeForBusinessLastActivityDate"];
            } else {
                $this->_propDict["skypeForBusinessLastActivityDate"] = new \Microsoft\Graph\Core\Models\Date($this->_propDict["skypeForBusinessLastActivityDate"]);
                return $this->_propDict["skypeForBusinessLastActivityDate"];
            }
        }
        return null;
    ...
    * The date when user last organized or participated in conferences, or joined peer-to-peer sessions.
    *
    * @param \Microsoft\Graph\Core\Models\Date $val The skypeForBusinessLastActivityDate
    *
    * @return Office365ActiveUserDetail
    */
    ...
    *
    * @return \Microsoft\Graph\Core\Models\Date|null The skypeForBusinessLicenseAssignDate
    */
    public function getSkypeForBusinessLicenseAssignDate()
    {
        if (array_key_exists("skypeForBusinessLicenseAssignDate", $this->_propDict)) {
            if (is_a($this->_propDict["skypeForBusinessLicenseAssignDate"], "\Microsoft\Graph\Core\Models\Date") || is_null($this->_propDict["skypeForBusinessLicenseAssignDate"])) {
                return $this->_propDict["skypeForBusinessLicenseAssignDate"];
            } else {
                $this->_propDict["skypeForBusinessLicenseAssignDate"] = new \Microsoft\Graph\Core\Models\Date($this->_propDict["skypeForBusinessLicenseAssignDate"]);
                return $this->_propDict["skypeForBusinessLicenseAssignDate"];
            }
        }
        return null;
    ...
    * The last date when the user was assigned a Skype For Business license.
    *
    * @param \Microsoft\Graph\Core\Models\Date $val The skypeForBusinessLicenseAssignDate
    *
    * @return Office365ActiveUserDetail
    */
    ...
    *
    * @return \Microsoft\Graph\Core\Models\Date|null The teamsLastActivityDate
    */
    public function getTeamsLastActivityDate()
    {
        if (array_key_exists("teamsLastActivityDate", $this->_propDict)) {
            if (is_a($this->_propDict["teamsLastActivityDate"], "\Microsoft\Graph\Core\Models\Date") || is_null($this->_propDict["teamsLastActivityDate"])) {
                return $this->_propDict["teamsLastActivityDate"];
            } else {
                $this->_propDict["teamsLastActivityDate"] = new \Microsoft\Graph\Core\Models\Date($this->_propDict["teamsLastActivityDate"]);
                return $this->_propDict["teamsLastActivityDate"];
            }
        }
        return null;
    ...
    * The date when user last posted messages in team channels, sent messages in private chat sessions, or participated in meetings or calls.
    *
    * @param \Microsoft\Graph\Core\Models\Date $val The teamsLastActivityDate
    *
    * @return Office365ActiveUserDetail
    */
    ...
    *
    * @return \Microsoft\Graph\Core\Models\Date|null The teamsLicenseAssignDate
    */
    public function getTeamsLicenseAssignDate()
    {
        if (array_key_exists("teamsLicenseAssignDate", $this->_propDict)) {
            if (is_a($this->_propDict["teamsLicenseAssignDate"], "\Microsoft\Graph\Core\Models\Date") || is_null($this->_propDict["teamsLicenseAssignDate"])) {
                return $this->_propDict["teamsLicenseAssignDate"];
            } else {
                $this->_propDict["teamsLicenseAssignDate"] = new \Microsoft\Graph\Core\Models\Date($this->_propDict["teamsLicenseAssignDate"]);
                return $this->_propDict["teamsLicenseAssignDate"];
            }
        }
        return null;
    ...
    * The last date when the user was assigned a Teams license.
    *
    * @param \Microsoft\Graph\Core\Models\Date $val The teamsLicenseAssignDate
    *
    * @return Office365ActiveUserDetail
    */
    ...
    *
    * @return \Microsoft\Graph\Core\Models\Date|null The yammerLastActivityDate
    */
    public function getYammerLastActivityDate()
    {
        if (array_key_exists("yammerLastActivityDate", $this->_propDict)) {
            if (is_a($this->_propDict["yammerLastActivityDate"], "\Microsoft\Graph\Core\Models\Date") || is_null($this->_propDict["yammerLastActivityDate"])) {
                return $this->_propDict["yammerLastActivityDate"];
            } else {
                $this->_propDict["yammerLastActivityDate"] = new \Microsoft\Graph\Core\Models\Date($this->_propDict["yammerLastActivityDate"]);
                return $this->_propDict["yammerLastActivityDate"];
            }
        }
        return null;
    ...
    * The date when user last posted, read, or liked message.
    *
    * @param \Microsoft\Graph\Core\Models\Date $val The yammerLastActivityDate
    *
    * @return Office365ActiveUserDetail
    */
    ...
    *
    * @return \Microsoft\Graph\Core\Models\Date|null The yammerLicenseAssignDate
    */
    public function getYammerLicenseAssignDate()
    {
        if (array_key_exists("yammerLicenseAssignDate", $this->_propDict)) {
            if (is_a($this->_propDict["yammerLicenseAssignDate"], "\Microsoft\Graph\Core\Models\Date") || is_null($this->_propDict["yammerLicenseAssignDate"])) {
                return $this->_propDict["yammerLicenseAssignDate"];
            } else {
                $this->_propDict["yammerLicenseAssignDate"] = new \Microsoft\Graph\Core\Models\Date($this->_propDict["yammerLicenseAssignDate"]);
                return $this->_propDict["yammerLicenseAssignDate"];
            }
        }
        return null;
    ...
    * The last date when the user was assigned a Yammer license.
    *
    * @param \Microsoft\Graph\Core\Models\Date $val The yammerLicenseAssignDate
    *
    * @return Office365ActiveUserDetail
    */

    ...
    */
    public function getAlternativeRecording()
    {
        if (array_key_exists("alternativeRecording", $this->_propDict)) {
            if (is_a($this->_propDict["alternativeRecording"], \Psr\Http\Message\StreamInterface::class) || is_null($this->_propDict["alternativeRecording"])) {
    ...
    */
    public function getAttendeeReport()
    {
        if (array_key_exists("attendeeReport", $this->_propDict)) {
            if (is_a($this->_propDict["attendeeReport"], \Psr\Http\Message\StreamInterface::class) || is_null($this->_propDict["attendeeReport"])) {
    ...
    */
    public function getRecording()
    {
        if (array_key_exists("recording", $this->_propDict)) {
            if (is_a($this->_propDict["recording"], \Psr\Http\Message\StreamInterface::class) || is_null($this->_propDict["recording"])) {

...
* 
* GcpAuthorizationSystemTypeAction File
* PHP version 7
*
* @category  Library
...
/**
* GcpAuthorizationSystemTypeAction class
*
* @category  Model
* @package   Microsoft.Graph
* @copyright (c) Microsoft Corporation. All rights reserved.
...
* @link      https://graph.microsoft.com
*/
class GcpAuthorizationSystemTypeAction extends AuthorizationSystemTypeAction
{
    /**
    * Gets the service
    *

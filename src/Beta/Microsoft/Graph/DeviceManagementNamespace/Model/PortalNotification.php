    ...
    */
    public function getAlertImpact()
    {
        if (array_key_exists("alertImpact", $this->_propDict)) {
            if (is_a($this->_propDict["alertImpact"], "\Beta\Microsoft\Graph\DeviceManagement\Model\AlertImpact") || is_null($this->_propDict["alertImpact"])) {
    ...
    */
    public function getAlertRuleTemplate()
    {
        if (array_key_exists("alertRuleTemplate", $this->_propDict)) {
            if (is_a($this->_propDict["alertRuleTemplate"], "\Beta\Microsoft\Graph\DeviceManagement\Model\AlertRuleTemplate") || is_null($this->_propDict["alertRuleTemplate"])) {
    ...
    */
    public function getSeverity()
    {
        if (array_key_exists("severity", $this->_propDict)) {
            if (is_a($this->_propDict["severity"], "\Beta\Microsoft\Graph\DeviceManagement\Model\RuleSeverityType") || is_null($this->_propDict["severity"])) {

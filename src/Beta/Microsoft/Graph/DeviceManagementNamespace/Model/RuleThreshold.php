    ...
    */
    public function getAggregation()
    {
        if (array_key_exists("aggregation", $this->_propDict)) {
            if (is_a($this->_propDict["aggregation"], "\Beta\Microsoft\Graph\DeviceManagement\Model\AggregationType") || is_null($this->_propDict["aggregation"])) {
    ...
    */
    public function getOperator()
    {
        if (array_key_exists("operator", $this->_propDict)) {
            if (is_a($this->_propDict["operator"], "\Beta\Microsoft\Graph\DeviceManagement\Model\OperatorType") || is_null($this->_propDict["operator"])) {

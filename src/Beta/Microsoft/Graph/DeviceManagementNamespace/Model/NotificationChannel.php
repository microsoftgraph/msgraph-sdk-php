    ...
    */
    public function getNotificationChannelType()
    {
        if (array_key_exists("notificationChannelType", $this->_propDict)) {
            if (is_a($this->_propDict["notificationChannelType"], "\Beta\Microsoft\Graph\DeviceManagement\Model\NotificationChannelType") || is_null($this->_propDict["notificationChannelType"])) {
    ...
    */
    public function getNotificationReceivers()
    {
        if (array_key_exists("notificationReceivers", $this->_propDict)) {
            if (is_a($this->_propDict["notificationReceivers"], "\Beta\Microsoft\Graph\DeviceManagement\Model\NotificationReceiver") || is_null($this->_propDict["notificationReceivers"])) {

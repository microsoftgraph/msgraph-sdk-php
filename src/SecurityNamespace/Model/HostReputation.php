...
* @link      https://graph.microsoft.com
*/
class HostReputation extends \Microsoft\Graph\Model\Entity
{
    /**
    ...
    */
    public function getClassification()
    {
        if (array_key_exists("classification", $this->_propDict)) {
            if (is_a($this->_propDict["classification"], "\Microsoft\Graph\SecurityNamespace\Model\HostReputationClassification") || is_null($this->_propDict["classification"])) {

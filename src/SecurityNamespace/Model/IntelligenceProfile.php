...
* @link      https://graph.microsoft.com
*/
class IntelligenceProfile extends \Microsoft\Graph\Model\Entity
{
    /**
    * Gets the aliases
    ...
    */
    public function getDescription()
    {
        if (array_key_exists("description", $this->_propDict)) {
            if (is_a($this->_propDict["description"], "\Microsoft\Graph\SecurityNamespace\Model\FormattedContent") || is_null($this->_propDict["description"])) {
    ...
    */
    public function getKind()
    {
        if (array_key_exists("kind", $this->_propDict)) {
            if (is_a($this->_propDict["kind"], "\Microsoft\Graph\SecurityNamespace\Model\IntelligenceProfileKind") || is_null($this->_propDict["kind"])) {
    ...
    */
    public function getTradecraft()
    {
        if (array_key_exists("tradecraft", $this->_propDict)) {
            if (is_a($this->_propDict["tradecraft"], "\Microsoft\Graph\SecurityNamespace\Model\FormattedContent") || is_null($this->_propDict["tradecraft"])) {

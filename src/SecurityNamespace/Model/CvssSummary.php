...
* @link      https://graph.microsoft.com
*/
class CvssSummary extends \Microsoft\Graph\Model\Entity
{
    /**
    * Gets the score
    ...
    */
    public function getSeverity()
    {
        if (array_key_exists("severity", $this->_propDict)) {
            if (is_a($this->_propDict["severity"], "\Microsoft\Graph\SecurityNamespace\Model\VulnerabilitySeverity") || is_null($this->_propDict["severity"])) {

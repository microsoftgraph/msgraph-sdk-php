    ...
    */
    public function getCloudResource()
    {
        if (array_key_exists("cloudResource", $this->_propDict)) {
            if (is_a($this->_propDict["cloudResource"], "\Microsoft\Graph\SecurityNamespace\Model\AlertEvidence") || is_null($this->_propDict["cloudResource"])) {
    ...
    */
    public function getPlatform()
    {
        if (array_key_exists("platform", $this->_propDict)) {
            if (is_a($this->_propDict["platform"], "\Microsoft\Graph\SecurityNamespace\Model\KubernetesPlatform") || is_null($this->_propDict["platform"])) {
